...
@interface JSAPIVideo : JSAPIObject


@property(nonatomic) NSNumber* active;

@property(nonatomic) JSAPIArtist* author;
...
@property(nonatomic) JSAPICollectionVideoContribution_* contributors;
...
@property(nonatomic) NSArray<JSAPIVideoTag>* tags;

@property(nonatomic) NSString* thumbnail;

@property(nonatomic) NSNumber* updated;

@property(nonatomic) JSAPIUser* uploader;

@property(nonatomic) NSNumber* views;

@property(nonatomic) NSArray<JSAPIUser>* whitelist;
