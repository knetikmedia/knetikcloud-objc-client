...
@class JSAPITopicSubscriberResource;



@protocol JSAPIPageResourceTopicSubscriberResource_
@end

@interface JSAPIPageResourceTopicSubscriberResource_ : JSAPIObject


@property(nonatomic) NSArray<JSAPITopicSubscriberResource>* content;
