#import "JSAPIFormattedTextPropertyDefinitionResource.h"

@implementation JSAPIFormattedTextPropertyDefinitionResource
...
+ (NSDictionary *)modalDictionary {
  ...
  [mutableDictionary addEntriesFromDictionary:@{ @"maxLength": @"max_length" }];
