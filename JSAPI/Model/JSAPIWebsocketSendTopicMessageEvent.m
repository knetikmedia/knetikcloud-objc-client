#import "JSAPIWebsocketSendTopicMessageEvent.h"

@implementation JSAPIWebsocketSendTopicMessageEvent
...
+ (NSDictionary *)modalDictionary {
  ...
  [mutableDictionary addEntriesFromDictionary:@{ @"content": @"content", @"topic": @"topic" }];
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"content", @"topic"];
