#import "JSAPILogLevelEvent.h"

@implementation JSAPILogLevelEvent
...
+ (NSDictionary *)modalDictionary {
  ...
  [mutableDictionary addEntriesFromDictionary:@{ @"level": @"level", @"name": @"name" }];
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"level", @"name"];
