#import "JSAPIServiceDeployedEvent.h"

@implementation JSAPIServiceDeployedEvent
...
+ (NSDictionary *)modalDictionary {
  ...
  [mutableDictionary addEntriesFromDictionary:@{ @"events": @"events", @"resources": @"resources", @"serviceName": @"service_name", @"swaggerUrl": @"swagger_url" }];
