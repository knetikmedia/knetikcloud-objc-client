#import "JSAPIWebsocketRemoveTopicEvent.h"

@implementation JSAPIWebsocketRemoveTopicEvent
...
+ (NSDictionary *)modalDictionary {
  ...
  [mutableDictionary addEntriesFromDictionary:@{ @"topic": @"topic" }];
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"topic"];
