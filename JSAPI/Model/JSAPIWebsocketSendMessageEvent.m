#import "JSAPIWebsocketSendMessageEvent.h"

@implementation JSAPIWebsocketSendMessageEvent
...
+ (NSDictionary *)modalDictionary {
  ...
  [mutableDictionary addEntriesFromDictionary:@{ @"content": @"content", @"usernames": @"usernames" }];
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"content", @"usernames"];
