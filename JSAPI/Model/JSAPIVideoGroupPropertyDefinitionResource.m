...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"maxHeight": @"max_height", @"maxLength": @"max_length", @"maxWidth": @"max_width", @"minHeight": @"min_height", @"minLength": @"min_length", @"minWidth": @"min_width" }];
}
