#import "JSAPIWebsocketSubscribeEvent.h"

@implementation JSAPIWebsocketSubscribeEvent
...
+ (NSDictionary *)modalDictionary {
  ...
  [mutableDictionary addEntriesFromDictionary:@{ @"topic": @"topic", @"userResource": @"user_resource" }];
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"topic", @"userResource"];
