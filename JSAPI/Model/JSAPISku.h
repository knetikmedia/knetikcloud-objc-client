...
/* The description of the SKU (Ex: An item comes in multiple sizes/colors, each needing its own unique description) [optional]
 */
...
/* Whether or not the SKU is currently published [optional]
 */
...
/* The date the sku becomes available, unix timestamp in seconds.  If set to null, sku will become available immediately [optional]
 */
