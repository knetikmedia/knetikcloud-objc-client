#import "JSAPIUsersAddressesApi.h"
...
@interface JSAPIUsersAddressesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIUsersAddressesApi

NSString* kJSAPIUsersAddressesApiErrorDomain = @"JSAPIUsersAddressesApiErrorDomain";
NSInteger kJSAPIUsersAddressesApiMissingParamErrorCode = 234513;
...
///
///  @returns JSAPISavedAddressResource*
///
-(NSURLSessionTask*) createAddressWithUserId: (NSString*) userId
    ...
    if (userId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPIUsersAddressesApiErrorDomain code:kJSAPIUsersAddressesApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"JSAPISavedAddressResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPISavedAddressResource*)data, error);
                                }
                            }];
}
...
///
///  @returns JSAPIPageResourceSavedAddressResource_*
///
-(NSURLSessionTask*) getAddressesWithUserId: (NSString*) userId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceSavedAddressResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceSavedAddressResource_*)data, error);
                                }
                            }];
}
