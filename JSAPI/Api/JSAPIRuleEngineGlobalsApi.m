#import "JSAPIRuleEngineGlobalsApi.h"
...
@interface JSAPIRuleEngineGlobalsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIRuleEngineGlobalsApi

NSString* kJSAPIRuleEngineGlobalsApiErrorDomain = @"JSAPIRuleEngineGlobalsApiErrorDomain";
NSInteger kJSAPIRuleEngineGlobalsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) deleteBREGlobalWithId: (NSString*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPIRuleEngineGlobalsApiErrorDomain code:kJSAPIRuleEngineGlobalsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
