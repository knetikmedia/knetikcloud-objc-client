#import "JSAPIContentCommentsApi.h"
...
@implementation JSAPIContentCommentsApi

NSString* kJSAPIContentCommentsApiErrorDomain = @"JSAPIContentCommentsApiErrorDomain";
NSInteger kJSAPIContentCommentsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) deleteCommentWithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPIContentCommentsApiErrorDomain code:kJSAPIContentCommentsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
...
-(NSURLSessionTask*) searchCommentsWithQuery: (NSObject*) query
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPICommentSearch*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPICommentSearch*)data, error);
                                }
                            }];
}
