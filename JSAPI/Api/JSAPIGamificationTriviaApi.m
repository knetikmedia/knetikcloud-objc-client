...
#import "JSAPICollectionString_.h"
...
///
///  @returns JSAPICollectionString_*
///
-(NSURLSessionTask*) searchQuestionTagsWithFilterSearch: (NSString*) filterSearch
    filterCategory: (NSString*) filterCategory
    filterImportId: (NSNumber*) filterImportId
    completionHandler: (void (^)(JSAPICollectionString_* output, NSError* error)) handler {
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPICollectionString_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPICollectionString_*)data, error);
                                }
                            }];
}
