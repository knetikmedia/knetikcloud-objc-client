...
@interface JSAPISocialGoogleApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPISocialGoogleApi

NSString* kJSAPISocialGoogleApiErrorDomain = @"JSAPISocialGoogleApiErrorDomain";
NSInteger kJSAPISocialGoogleApiMissingParamErrorCode = 234513;
