#import "JSAPIMessagingTopicsApi.h"
...
@interface JSAPIMessagingTopicsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIMessagingTopicsApi

NSString* kJSAPIMessagingTopicsApiErrorDomain = @"JSAPIMessagingTopicsApiErrorDomain";
NSInteger kJSAPIMessagingTopicsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) disableTopicSubscriberWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/messaging/topics/{id}/subscribers/{user_id}/disabled"];
...
///  @param userId The id of the subscriber or 'me' 
///
///  @returns JSAPITopicSubscriberResource*
///
-(NSURLSessionTask*) getTopicSubscriberWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/messaging/topics/{id}/subscribers/{user_id}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPITopicSubscriberResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPITopicSubscriberResource*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getUserTopicsWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/users/{id}/topics"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceTopicResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceTopicResource_*)data, error);
                                }
                            }];
}
