#import "JSAPICampaignsRewardsApi.h"
...
@interface JSAPICampaignsRewardsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPICampaignsRewardsApi

NSString* kJSAPICampaignsRewardsApiErrorDomain = @"JSAPICampaignsRewardsApiErrorDomain";
NSInteger kJSAPICampaignsRewardsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) createRewardSetWithRewardSetResource: (JSAPIRewardSetResource*) rewardSetResource
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"JSAPIRewardSetResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIRewardSetResource*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) deleteRewardSetWithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPICampaignsRewardsApiErrorDomain code:kJSAPICampaignsRewardsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
...
///
///  @returns JSAPIPageResourceRewardSetResource_*
///
-(NSURLSessionTask*) getRewardSetsWithSize: (NSNumber*) size
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceRewardSetResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceRewardSetResource_*)data, error);
                                }
                            }];
}
