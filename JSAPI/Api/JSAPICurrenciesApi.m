...
@interface JSAPICurrenciesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPICurrenciesApi

NSString* kJSAPICurrenciesApiErrorDomain = @"JSAPICurrenciesApiErrorDomain";
NSInteger kJSAPICurrenciesApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) deleteCurrencyWithCode: (NSString*) code
    ...
    if (code == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPICurrenciesApiErrorDomain code:kJSAPICurrenciesApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
...
-(NSURLSessionTask*) getCurrenciesWithFilterEnabledCurrencies: (NSNumber*) filterEnabledCurrencies
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceCurrencyResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceCurrencyResource_*)data, error);
                                }
                            }];
}
