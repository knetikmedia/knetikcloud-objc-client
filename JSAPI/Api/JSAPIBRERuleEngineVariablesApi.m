#import "JSAPIBRERuleEngineVariablesApi.h"
...
@interface JSAPIBRERuleEngineVariablesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIBRERuleEngineVariablesApi

NSString* kJSAPIBRERuleEngineVariablesApiErrorDomain = @"JSAPIBRERuleEngineVariablesApiErrorDomain";
NSInteger kJSAPIBRERuleEngineVariablesApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) getBREVariableValuesWithName: (NSString*) name
    ...
    if (name == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPIBRERuleEngineVariablesApiErrorDomain code:kJSAPIBRERuleEngineVariablesApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
