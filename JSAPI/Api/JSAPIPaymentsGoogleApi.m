#import "JSAPIPaymentsGoogleApi.h"
...
@interface JSAPIPaymentsGoogleApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIPaymentsGoogleApi

NSString* kJSAPIPaymentsGoogleApiErrorDomain = @"JSAPIPaymentsGoogleApiErrorDomain";
NSInteger kJSAPIPaymentsGoogleApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) handleGooglePaymentWithRequest: (JSAPIGooglePaymentRequest*) request
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/payment/provider/google/payments"];
