#import "JSAPINotificationsApi.h"
...
@interface JSAPINotificationsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPINotificationsApi

NSString* kJSAPINotificationsApiErrorDomain = @"JSAPINotificationsApiErrorDomain";
NSInteger kJSAPINotificationsApiMissingParamErrorCode = 234513;
...
///
///  @returns JSAPINotificationTypeResource*
///
-(NSURLSessionTask*) createNotificationTypeWithNotificationType: (JSAPINotificationTypeResource*) notificationType
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/notifications/types"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"JSAPINotificationTypeResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPINotificationTypeResource*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) deleteNotificationTypeWithId: (NSString*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPINotificationsApiErrorDomain code:kJSAPINotificationsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/notifications/types/{id}"];
...
///
///  @returns JSAPIPageResourceNotificationTypeResource_*
///
-(NSURLSessionTask*) getNotificationTypesWithSize: (NSNumber*) size
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceNotificationTypeResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceNotificationTypeResource_*)data, error);
                                }
                            }];
}
...
///
///  @returns JSAPINotificationUserTypeResource*
///
-(NSURLSessionTask*) getUserNotificationInfoWithTypeId: (NSString*) typeId
    ...
    if (typeId == nil) {
        NSParameterAssert(typeId);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"typeId"] };
            NSError* error = [NSError errorWithDomain:kJSAPINotificationsApiErrorDomain code:kJSAPINotificationsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/users/{user_id}/notifications/types/{type_id}"];

    NSMutableDictionary *pathParams = [[NSMutableDictionary alloc] init];
    if (typeId != nil) {
        pathParams[@"type_id"] = typeId;
    }
    if (userId != nil) {
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPINotificationUserTypeResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPINotificationUserTypeResource*)data, error);
                                }
                            }];
}
...
///  @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)
///
///  @returns JSAPIPageResourceNotificationUserTypeResource_*
///
-(NSURLSessionTask*) getUserNotificationInfoListWithUserId: (NSString*) userId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/users/{user_id}/notifications/types"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceNotificationUserTypeResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceNotificationUserTypeResource_*)data, error);
                                }
                            }];
}
...
///  @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)
///
///  @returns JSAPIPageResourceUserNotificationResource_*
///
-(NSURLSessionTask*) getUserNotificationsWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/users/{id}/notifications"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPIPageResourceUserNotificationResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPIPageResourceUserNotificationResource_*)data, error);
                                }
                            }];
}
...
///
///  @returns JSAPINotificationResource*
///
-(NSURLSessionTask*) sendNotificationWithNotification: (JSAPINotificationResource*) notification
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/notifications"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"JSAPINotificationResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((JSAPINotificationResource*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) setUserNotificationStatusWithUserId: (NSString*) userId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/users/{user_id}/notifications/{notification_id}/status"];
...
-(NSURLSessionTask*) silenceDirectNotificationsWithTypeId: (NSString*) typeId
    ...
    if (silenced == nil) {
        NSParameterAssert(silenced);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"silenced"] };
            NSError* error = [NSError errorWithDomain:kJSAPINotificationsApiErrorDomain code:kJSAPINotificationsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/users/{user_id}/notifications/types/{type_id}/silenced"];
