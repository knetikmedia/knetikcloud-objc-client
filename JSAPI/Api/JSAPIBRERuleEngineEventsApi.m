#import "JSAPIBRERuleEngineEventsApi.h"
...
@interface JSAPIBRERuleEngineEventsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIBRERuleEngineEventsApi

NSString* kJSAPIBRERuleEngineEventsApiErrorDomain = @"JSAPIBRERuleEngineEventsApiErrorDomain";
NSInteger kJSAPIBRERuleEngineEventsApiMissingParamErrorCode = 234513;
