#import "JSAPIBRERuleEngineRulesApi.h"
...
@interface JSAPIBRERuleEngineRulesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIBRERuleEngineRulesApi

NSString* kJSAPIBRERuleEngineRulesApiErrorDomain = @"JSAPIBRERuleEngineRulesApiErrorDomain";
NSInteger kJSAPIBRERuleEngineRulesApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) deleteBRERuleWithId: (NSString*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPIBRERuleEngineRulesApiErrorDomain code:kJSAPIBRERuleEngineRulesApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
