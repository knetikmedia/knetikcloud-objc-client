#import "JSAPIBRERuleEngineActionsApi.h"
...
@interface JSAPIBRERuleEngineActionsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIBRERuleEngineActionsApi

NSString* kJSAPIBRERuleEngineActionsApiErrorDomain = @"JSAPIBRERuleEngineActionsApiErrorDomain";
NSInteger kJSAPIBRERuleEngineActionsApiMissingParamErrorCode = 234513;
