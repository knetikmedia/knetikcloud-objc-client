...
@interface JSAPIContentPollsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIContentPollsApi

NSString* kJSAPIContentPollsApiErrorDomain = @"JSAPIContentPollsApiErrorDomain";
NSInteger kJSAPIContentPollsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) answerPollWithId: (NSString*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPIContentPollsApiErrorDomain code:kJSAPIContentPollsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
