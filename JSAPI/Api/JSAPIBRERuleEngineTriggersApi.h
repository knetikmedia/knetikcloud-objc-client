...
@interface JSAPIBRERuleEngineTriggersApi: NSObject <JSAPIApi>

extern NSString* kJSAPIBRERuleEngineTriggersApiErrorDomain;
extern NSInteger kJSAPIBRERuleEngineTriggersApiMissingParamErrorCode;
