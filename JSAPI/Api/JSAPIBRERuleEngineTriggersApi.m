#import "JSAPIBRERuleEngineTriggersApi.h"
...
@interface JSAPIBRERuleEngineTriggersApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation JSAPIBRERuleEngineTriggersApi

NSString* kJSAPIBRERuleEngineTriggersApiErrorDomain = @"JSAPIBRERuleEngineTriggersApiErrorDomain";
NSInteger kJSAPIBRERuleEngineTriggersApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) deleteBRETriggerWithEventName: (NSString*) eventName
    ...
    if (eventName == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPIBRERuleEngineTriggersApiErrorDomain code:kJSAPIBRERuleEngineTriggersApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
