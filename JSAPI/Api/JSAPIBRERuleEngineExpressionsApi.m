...
-(NSURLSessionTask*) getBREExpressionWithType: (NSString*) type
    ...
    if (type == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kJSAPIBRERuleEngineExpressionsApiErrorDomain code:kJSAPIBRERuleEngineExpressionsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
