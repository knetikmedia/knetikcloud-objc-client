...
NSString *const JSAPIDeserializationErrorDomainKey = @"JSAPIDeserializationErrorDomainKey";

NSInteger const JSAPITypeMismatchErrorCode = 143553;

NSInteger const JSAPIEmptyValueOccurredErrorCode = 143509;

NSInteger const JSAPIUnknownResponseObjectErrorCode = 143528;


@interface JSAPIResponseDeserializer ()
...
@implementation JSAPIResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:JSAPIDeserializationErrorDomainKey code:JSAPITypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:JSAPIDeserializationErrorDomainKey code:JSAPIEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:JSAPIDeserializationErrorDomainKey code:JSAPIUnknownResponseObjectErrorCode userInfo:userInfo];
}
