...
@protocol SWGPageResourceQuestionTemplateResource_
@end

@interface SWGPageResourceQuestionTemplateResource_ : SWGObject


@property(nonatomic) NSArray<SWGQuestionTemplateResource>* content;
