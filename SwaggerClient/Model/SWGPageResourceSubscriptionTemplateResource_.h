...
@protocol SWGPageResourceSubscriptionTemplateResource_
@end

@interface SWGPageResourceSubscriptionTemplateResource_ : SWGObject


@property(nonatomic) NSArray<SWGSubscriptionTemplateResource>* content;
