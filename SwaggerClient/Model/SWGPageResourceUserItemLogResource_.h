...
@protocol SWGPageResourceUserItemLogResource_
@end

@interface SWGPageResourceUserItemLogResource_ : SWGObject


@property(nonatomic) NSArray<SWGUserItemLogResource>* content;
