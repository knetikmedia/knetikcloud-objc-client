...
@protocol SWGPageResourceSimpleUserResource_
@end

@interface SWGPageResourceSimpleUserResource_ : SWGObject


@property(nonatomic) NSArray<SWGSimpleUserResource>* content;
