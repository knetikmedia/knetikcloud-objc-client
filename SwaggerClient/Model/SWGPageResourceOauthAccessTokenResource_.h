...
@protocol SWGPageResourceOauthAccessTokenResource_
@end

@interface SWGPageResourceOauthAccessTokenResource_ : SWGObject


@property(nonatomic) NSArray<SWGOauthAccessTokenResource>* content;
