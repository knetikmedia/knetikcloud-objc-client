...
@protocol SWGPageResourceTransactionResource_
@end

@interface SWGPageResourceTransactionResource_ : SWGObject


@property(nonatomic) NSArray<SWGTransactionResource>* content;
