...
@protocol SWGPageResourceBreCategoryResource_
@end

@interface SWGPageResourceBreCategoryResource_ : SWGObject


@property(nonatomic) NSArray<SWGBreCategoryResource>* content;
