...
@protocol SWGPageResourceAggregateCountResource_
@end

@interface SWGPageResourceAggregateCountResource_ : SWGObject


@property(nonatomic) NSArray<SWGAggregateCountResource>* content;
