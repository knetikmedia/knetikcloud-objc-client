...
@protocol SWGPageResourceSubscriptionResource_
@end

@interface SWGPageResourceSubscriptionResource_ : SWGObject


@property(nonatomic) NSArray<SWGSubscriptionResource>* content;
