...
@protocol SWGPageUserAchievementResource_
@end

@interface SWGPageUserAchievementResource_ : SWGObject


@property(nonatomic) NSArray<SWGUserAchievementResource>* content;
