...
@protocol SWGPageResourceWalletTotalResponse_
@end

@interface SWGPageResourceWalletTotalResponse_ : SWGObject


@property(nonatomic) NSArray<SWGWalletTotalResponse>* content;
