...
@protocol SWGQuestionResource
@end

@interface SWGQuestionResource : SWGObject
 ...
 */
@property(nonatomic) NSArray<SWGAnswerResource>* answers;
 ...
 */
@property(nonatomic) SWGProperty* question;
