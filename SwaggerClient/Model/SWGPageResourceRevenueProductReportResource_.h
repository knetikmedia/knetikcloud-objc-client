...
@protocol SWGPageResourceRevenueProductReportResource_
@end

@interface SWGPageResourceRevenueProductReportResource_ : SWGObject


@property(nonatomic) NSArray<SWGRevenueProductReportResource>* content;
