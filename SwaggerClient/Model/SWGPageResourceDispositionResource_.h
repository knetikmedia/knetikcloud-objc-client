...
@protocol SWGPageResourceDispositionResource_
@end

@interface SWGPageResourceDispositionResource_ : SWGObject


@property(nonatomic) NSArray<SWGDispositionResource>* content;
