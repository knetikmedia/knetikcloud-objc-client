...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"additionalProperties", @"behaviors", @"category", @"createdDate", @"discountMax", @"discountMinCartValue", @"displayable", @"exclusive", @"geoCountryList", @"geoPolicyType", @"_id", @"itemId", @"longDescription", @"maxQuantity", @"shippingTier", @"shortDescription", @"sort", @"storeEnd", @"storeStart", @"tags", @"template", @"uniqueKey", @"updatedDate", @"validForTags", ];
