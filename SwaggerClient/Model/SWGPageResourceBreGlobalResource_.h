...
@protocol SWGPageResourceBreGlobalResource_
@end

@interface SWGPageResourceBreGlobalResource_ : SWGObject


@property(nonatomic) NSArray<SWGBreGlobalResource>* content;
