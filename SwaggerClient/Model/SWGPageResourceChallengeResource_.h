...
@protocol SWGPageResourceChallengeResource_
@end

@interface SWGPageResourceChallengeResource_ : SWGObject


@property(nonatomic) NSArray<SWGChallengeResource>* content;
