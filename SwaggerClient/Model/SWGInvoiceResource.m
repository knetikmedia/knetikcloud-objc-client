...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"billingAddress1", @"billingAddress2", @"billingCityName", @"billingCountryName", @"billingFullName", @"billingPostalCode", @"billingStateName", @"cartId", @"createdDate", @"currency", @"currentFulfillmentStatus", @"currentPaymentStatus", @"discount", @"email", @"externalRef", @"fedTax", @"grandTotal", @"_id", @"invoiceNumber", @"items", @"namePrefix", @"orderNotes", @"parentInvoiceId", @"paymentMethodId", @"phone", @"phoneNumber", @"shipping", @"shippingAddress1", @"shippingAddress2", @"shippingCityName", @"shippingCountryName", @"shippingFullName", @"shippingPostalCode", @"shippingStateName", @"sort", @"stateTax", @"subtotal", @"updatedDate", @"user", @"vendorId", @"vendorName"];
