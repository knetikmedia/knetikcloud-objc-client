...
@protocol SWGPageResourceItemTemplateResource_
@end

@interface SWGPageResourceItemTemplateResource_ : SWGObject


@property(nonatomic) NSArray<SWGItemTemplateResource>* content;
