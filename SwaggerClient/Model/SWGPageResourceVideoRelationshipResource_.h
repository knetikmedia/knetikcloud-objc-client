...
@protocol SWGPageResourceVideoRelationshipResource_
@end

@interface SWGPageResourceVideoRelationshipResource_ : SWGObject


@property(nonatomic) NSArray<SWGVideoRelationshipResource>* content;
