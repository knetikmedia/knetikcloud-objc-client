...
@protocol SWGPageResourceRewardSetResource_
@end

@interface SWGPageResourceRewardSetResource_ : SWGObject


@property(nonatomic) NSArray<SWGRewardSetResource>* content;
