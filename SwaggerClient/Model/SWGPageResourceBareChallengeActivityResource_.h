...
@protocol SWGPageResourceBareChallengeActivityResource_
@end

@interface SWGPageResourceBareChallengeActivityResource_ : SWGObject


@property(nonatomic) NSArray<SWGBareChallengeActivityResource>* content;
