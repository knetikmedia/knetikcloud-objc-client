...
@implementation SWGCampaignResource
...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"active": @"active", @"additionalProperties": @"additional_properties", @"createdDate": @"created_date", @"_id": @"id", @"leaderboardStrategy": @"leaderboard_strategy", @"longDescription": @"long_description", @"name": @"name", @"nextChallenge": @"next_challenge", @"nextChallengeDate": @"next_challenge_date", @"rewardSet": @"reward_set", @"rewardStatus": @"reward_status", @"shortDescription": @"short_description", @"template": @"template", @"updatedDate": @"updated_date" }];
}
