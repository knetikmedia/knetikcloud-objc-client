...
@protocol SWGPageResourceBareActivityResource_
@end

@interface SWGPageResourceBareActivityResource_ : SWGObject


@property(nonatomic) NSArray<SWGBareActivityResource>* content;
