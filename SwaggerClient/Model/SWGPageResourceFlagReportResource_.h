...
@protocol SWGPageResourceFlagReportResource_
@end

@interface SWGPageResourceFlagReportResource_ : SWGObject


@property(nonatomic) NSArray<SWGFlagReportResource>* content;
