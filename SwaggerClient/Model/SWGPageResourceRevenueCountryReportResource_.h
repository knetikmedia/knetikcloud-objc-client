...
@protocol SWGPageResourceRevenueCountryReportResource_
@end

@interface SWGPageResourceRevenueCountryReportResource_ : SWGObject


@property(nonatomic) NSArray<SWGRevenueCountryReportResource>* content;
