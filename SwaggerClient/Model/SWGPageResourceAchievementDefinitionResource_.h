...
@protocol SWGPageResourceAchievementDefinitionResource_
@end

@interface SWGPageResourceAchievementDefinitionResource_ : SWGObject


@property(nonatomic) NSArray<SWGAchievementDefinitionResource>* content;
