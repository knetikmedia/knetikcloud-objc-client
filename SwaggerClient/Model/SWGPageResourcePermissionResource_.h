...
@protocol SWGPageResourcePermissionResource_
@end

@interface SWGPageResourcePermissionResource_ : SWGObject


@property(nonatomic) NSArray<SWGPermissionResource>* content;
