...
@protocol SWGPageResourceImportJobResource_
@end

@interface SWGPageResourceImportJobResource_ : SWGObject


@property(nonatomic) NSArray<SWGImportJobResource>* content;
