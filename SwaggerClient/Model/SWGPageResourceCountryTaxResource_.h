...
@protocol SWGPageResourceCountryTaxResource_
@end

@interface SWGPageResourceCountryTaxResource_ : SWGObject


@property(nonatomic) NSArray<SWGCountryTaxResource>* content;
