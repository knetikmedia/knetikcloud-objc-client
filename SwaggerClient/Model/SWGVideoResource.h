...
@protocol SWGVideoResource
@end

@interface SWGVideoResource : SWGObject
 ...
 */
@property(nonatomic) SWGSimpleReferenceResourceLong_* author;
 ...
 */
@property(nonatomic) SWGSimpleReferenceResourceString_* category;
/* The comments of the video [optional]
 */
@property(nonatomic) NSArray<SWGCommentResource>* comments;
/* Artists that contributed to the creation. See separate endpoint to add to list [optional]
 */
@property(nonatomic) NSArray<SWGContributionResource>* contributors;
 ...
 */
@property(nonatomic) SWGSimpleUserResource* uploader;
