...
@implementation SWGChallengeResource
...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"activities": @"activities", @"additionalProperties": @"additional_properties", @"campaignId": @"campaign_id", @"varCopyOf": @"copy_of", @"createdDate": @"created_date", @"endDate": @"end_date", @"_id": @"id", @"leaderboardStrategy": @"leaderboard_strategy", @"longDescription": @"long_description", @"name": @"name", @"nextEventDate": @"next_event_date", @"rewardLagMinutes": @"reward_lag_minutes", @"rewardSet": @"reward_set", @"schedule": @"schedule", @"shortDescription": @"short_description", @"startDate": @"start_date", @"template": @"template", @"updatedDate": @"updated_date" }];
}
