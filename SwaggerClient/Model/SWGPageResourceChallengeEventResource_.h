...
@protocol SWGPageResourceChallengeEventResource_
@end

@interface SWGPageResourceChallengeEventResource_ : SWGObject


@property(nonatomic) NSArray<SWGChallengeEventResource>* content;
