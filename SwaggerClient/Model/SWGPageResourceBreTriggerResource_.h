...
@protocol SWGPageResourceBreTriggerResource_
@end

@interface SWGPageResourceBreTriggerResource_ : SWGObject


@property(nonatomic) NSArray<SWGBreTriggerResource>* content;
