...
@protocol SWGPageResourceUserLevelingResource_
@end

@interface SWGPageResourceUserLevelingResource_ : SWGObject


@property(nonatomic) NSArray<SWGUserLevelingResource>* content;
