...
@protocol SWGPageResourceUserInventoryResource_
@end

@interface SWGPageResourceUserInventoryResource_ : SWGObject


@property(nonatomic) NSArray<SWGUserInventoryResource>* content;
