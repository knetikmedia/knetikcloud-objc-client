...
@protocol SWGPageResourceChallengeEventParticipantResource_
@end

@interface SWGPageResourceChallengeEventParticipantResource_ : SWGObject


@property(nonatomic) NSArray<SWGChallengeEventParticipantResource>* content;
