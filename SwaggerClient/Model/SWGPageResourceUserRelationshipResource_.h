...
@protocol SWGPageResourceUserRelationshipResource_
@end

@interface SWGPageResourceUserRelationshipResource_ : SWGObject


@property(nonatomic) NSArray<SWGUserRelationshipResource>* content;
