...
@protocol SWGPageResourceStoreItemTemplateResource_
@end

@interface SWGPageResourceStoreItemTemplateResource_ : SWGObject


@property(nonatomic) NSArray<SWGStoreItemTemplateResource>* content;
