#import "SWGConfigsApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGConfig.h"
#import "SWGPageConfig_.h"


@interface SWGConfigsApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGConfigsApi

NSString* kSWGConfigsApiErrorDomain = @"SWGConfigsApiErrorDomain";
NSInteger kSWGConfigsApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGConfigsApi *sharedAPI;
...
-(NSNumber*) createConfigUsingPOSTWithConfig: (SWGConfig*) config
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGConfig*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGConfig*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) deleteConfigUsingDELETEWithName: (NSString*) name
    ...
    if (name == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGConfigsApiErrorDomain code:kSWGConfigsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
...
-(NSNumber*) getConfigsUsingGETWithFilterSearch: (NSString*) filterSearch
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageConfig_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageConfig_*)data, error);
                                }
                           }
          ];
}
