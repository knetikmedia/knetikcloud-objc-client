#import "SWGMediaModerationApi.h"
...
@interface SWGMediaModerationApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGMediaModerationApi

NSString* kSWGMediaModerationApiErrorDomain = @"SWGMediaModerationApiErrorDomain";
NSInteger kSWGMediaModerationApiMissingParamErrorCode = 234513;
...
///  @returns void
///
-(NSURLSessionTask*) getFlagReportUsingGETWithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGMediaModerationApiErrorDomain code:kSWGMediaModerationApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
...
///
///  @returns SWGPageResourceFlagReportResource_*
///
-(NSURLSessionTask*) getFlagsReportUsingGETWithExcludeResolved: (NSNumber*) excludeResolved
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceFlagReportResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceFlagReportResource_*)data, error);
                                }
                            }];
}
...
///  @returns void
///
-(NSURLSessionTask*) setFlagResolutionUsingPUTWithId: (NSNumber*) _id
