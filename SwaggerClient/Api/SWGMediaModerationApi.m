...
+ (instancetype)sharedAPI {
    static SWGMediaModerationApi *sharedAPI;
...
///
///  @returns SWGPageFlagReportResource_*
///
-(NSNumber*) getFlagsReportUsingGETWithExcludeResolved: (NSNumber*) excludeResolved
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageFlagReportResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageFlagReportResource_*)data, error);
                                }
                           }
          ];
}
