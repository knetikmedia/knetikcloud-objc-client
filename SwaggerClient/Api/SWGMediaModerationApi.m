...
///
///  @returns SWGFlagReportResource*
///
-(NSURLSessionTask*) getModerationReportWithId: (NSNumber*) _id
    completionHandler: (void (^)(SWGFlagReportResource* output, NSError* error)) handler {
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGFlagReportResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGFlagReportResource*)data, error);
                                }
                            }];
}
