...
@interface SWGCategoriesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGCategoriesApi

NSString* kSWGCategoriesApiErrorDomain = @"SWGCategoriesApiErrorDomain";
NSInteger kSWGCategoriesApiMissingParamErrorCode = 234513;
...
///
///  @returns SWGCategoryResource*
///
-(NSURLSessionTask*) createCategoryUsingPOSTWithCategory: (SWGCategoryResource*) category
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGCategoryResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGCategoryResource*)data, error);
                                }
                            }];
}
...
///
-(NSURLSessionTask*) createTemplateUsingPOST2WithTemplate: (SWGTemplateResource*) template
...
///  @returns void
///
-(NSURLSessionTask*) deleteCategoryUsingDELETEWithId: (NSString*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGCategoriesApiErrorDomain code:kSWGCategoriesApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
...
///  @returns void
///
-(NSURLSessionTask*) deleteTemplateUsingDELETE1WithId: (NSString*) _id
...
///
-(NSURLSessionTask*) getArticleTemplatesUsingGET1WithSize: (NSNumber*) size
    page: (NSNumber*) page
...
///  @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)
///
///  @returns SWGPageResourceCategoryResource_*
///
-(NSURLSessionTask*) getCategoriesUsingGET1WithFilterSearch: (NSString*) filterSearch
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceCategoryResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceCategoryResource_*)data, error);
                                }
                            }];
}
...
///  @returns SWGCategoryResource*
///
-(NSURLSessionTask*) getCategoryUsingGET1WithId: (NSString*) _id
    completionHandler: (void (^)(SWGCategoryResource* output, NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
...
///  @param page The number of the page returned, starting with 1 (optional, default to 1)
///
///  @returns SWGPageResourceString_*
///
-(NSURLSessionTask*) getTagsUsingGETWithSize: (NSNumber*) size
    page: (NSNumber*) page
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceString_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceString_*)data, error);
                                }
                            }];
}
...
///  @returns SWGTemplateResource*
///
-(NSURLSessionTask*) getTemplateUsingGET1WithId: (NSString*) _id
    completionHandler: (void (^)(SWGTemplateResource* output, NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
...
///  @returns void
///
-(NSURLSessionTask*) updateCategoryUsingPUT1WithId: (NSString*) _id
...
///  @returns void
///
-(NSURLSessionTask*) updateTemplateUsingPUT2WithId: (NSString*) _id
