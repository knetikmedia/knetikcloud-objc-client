#import "SWGStoreShoppingCartsApi.h"
...
@interface SWGStoreShoppingCartsApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGStoreShoppingCartsApi

NSString* kSWGStoreShoppingCartsApiErrorDomain = @"SWGStoreShoppingCartsApiErrorDomain";
NSInteger kSWGStoreShoppingCartsApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGStoreShoppingCartsApi *sharedAPI;
...
-(NSNumber*) addDiscountUsingPOSTWithId: (NSString*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGStoreShoppingCartsApiErrorDomain code:kSWGStoreShoppingCartsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
...
///  @param _id The id of the cart 
///
///  @returns SWGCartShippableResponse*
///
-(NSNumber*) checkShippableUsingGETWithId: (NSString*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGCartShippableResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGCartShippableResponse*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getCartUsingGETWithId: (NSString*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGCart*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGCart*)data, error);
                                }
                           }
          ];
}
...
///  @param _id The id of the cart 
///
///  @returns SWGSampleCountriesResponse*
///
-(NSNumber*) getCountriesUsingGETWithId: (NSString*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGSampleCountriesResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGSampleCountriesResponse*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) searchCartsUsingGETWithFilterOwnerId: (NSNumber*) filterOwnerId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageCartSummary_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageCartSummary_*)data, error);
                                }
                           }
          ];
}
