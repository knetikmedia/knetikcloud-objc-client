...
///
///  @returns SWGPageChallengeEventParticipantResource_*
///
-(NSNumber*) getChallengeEventLeaderboardUsingGETWithFilterEvent: (NSNumber*) filterEvent
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGPageChallengeEventParticipantResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageChallengeEventParticipantResource_*)data, error);
                                }
                           }
          ];
}
