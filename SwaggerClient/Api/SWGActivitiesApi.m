...
@interface SWGActivitiesApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGActivitiesApi

NSString* kSWGActivitiesApiErrorDomain = @"SWGActivitiesApiErrorDomain";
NSInteger kSWGActivitiesApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGActivitiesApi *sharedAPI;
...
-(NSNumber*) completeActivityOccurrenceUsingPUTWithActivityOccurrenceId: (NSNumber*) activityOccurrenceId
    ...
    if (activityOccurrenceId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGActivitiesApiErrorDomain code:kSWGActivitiesApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
    ...
    bodyParam = activityCccurrenceStatus;
...
///
///  @returns SWGActivityOccurrenceResource*
///
-(NSNumber*) createActivityOccurrenceUsingPOSTWithTest: (NSNumber*) test
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGActivityOccurrenceResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGActivityOccurrenceResource*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) createActivityUsingPOSTWithActivityResource: (SWGActivityResource*) activityResource
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGActivityResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGActivityResource*)data, error);
                                }
                           }
          ];
}
...
///
///  @returns SWGPageBareActivityResource_*
///
-(NSNumber*) getActivitiesUsingGETWithFilterTemplate: (NSNumber*) filterTemplate
    size: (NSNumber*) size
    page: (NSNumber*) page
    order: (NSString*) order
    completionHandler: (void (^)(SWGPageBareActivityResource_* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/activities"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageBareActivityResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageBareActivityResource_*)data, error);
                                }
                           }
          ];
}
...
///
///  @returns SWGActivityOccurrenceResults*
///
-(NSNumber*) postResultsUsingPOSTWithActivityOccurrenceId: (NSNumber*) activityOccurrenceId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGActivityOccurrenceResults*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGActivityOccurrenceResults*)data, error);
                                }
                           }
          ];
}
