...
@interface SWGMediaVideosApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGMediaVideosApi

NSString* kSWGMediaVideosApiErrorDomain = @"SWGMediaVideosApiErrorDomain";
NSInteger kSWGMediaVideosApiMissingParamErrorCode = 234513;
...
///
///  @returns SWGCommentResource*
///
-(NSURLSessionTask*) addCommentUsingPOST1WithVideoId: (NSNumber*) videoId
    ...
    if (videoId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGMediaVideosApiErrorDomain code:kSWGMediaVideosApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGCommentResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGCommentResource*)data, error);
                                }
                            }];
}
...
///  @returns void
///
-(NSURLSessionTask*) addContributorUsingPOSTWithVideoId: (NSNumber*) videoId
...
///
///  @returns SWGDispositionResource*
///
-(NSURLSessionTask*) addDispositionUsingPOST1WithVideoId: (NSNumber*) videoId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGDispositionResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGDispositionResource*)data, error);
                                }
                            }];
}
...
///  @returns void
///
-(NSURLSessionTask*) addFlagUsingPOSTWithVideoId: (NSNumber*) videoId
...
///
///  @returns SWGVideoRelationshipResource*
///
-(NSURLSessionTask*) addRelatedUsingPOSTWithVideoId: (NSNumber*) videoId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGVideoRelationshipResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGVideoRelationshipResource*)data, error);
                                }
                            }];
}
...
///
///  @returns SWGVideoResource*
///
-(NSURLSessionTask*) addVideoUsingPOSTWithVideoResource: (SWGVideoResource*) videoResource
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGVideoResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGVideoResource*)data, error);
                                }
                            }];
}
...
///  @returns void
///
-(NSURLSessionTask*) addWhitelistUsingPOSTWithId: (NSNumber*) _id
...
///  @returns void
///
-(NSURLSessionTask*) deleteCommentUsingDELETE1WithVideoId: (NSNumber*) videoId
    _id: (NSNumber*) _id
    completionHandler: (void (^)(NSError* error)) handler {
    // verify the required parameter 'videoId' is set
    if (videoId == nil) {
...
///  @returns void
///
-(NSURLSessionTask*) deleteDispositionUsingDELETE1WithDispositionId: (NSNumber*) dispositionId
    completionHandler: (void (^)(NSError* error)) handler {
...
///  @returns void
///
-(NSURLSessionTask*) deleteFlagUsingDELETEWithVideoId: (NSNumber*) videoId
    completionHandler: (void (^)(NSError* error)) handler {
    // verify the required parameter 'videoId' is set
    if (videoId == nil) {
        NSParameterAssert(videoId);
...
///  @returns void
///
-(NSURLSessionTask*) deleteRelationshipUsingDELETE1WithVideoId: (NSNumber*) videoId
    _id: (NSNumber*) _id
    completionHandler: (void (^)(NSError* error)) handler {
    // verify the required parameter 'videoId' is set
    if (videoId == nil) {
...
///  @returns void
///
-(NSURLSessionTask*) deleteVideoUsingDELETEWithId: (NSNumber*) _id
    completionHandler: (void (^)(NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
...
///
///  @returns SWGPageResourceCommentResource_*
///
-(NSURLSessionTask*) getCommentsUsingGET1WithVideoId: (NSNumber*) videoId
    size: (NSNumber*) size
    page: (NSNumber*) page
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceCommentResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceCommentResource_*)data, error);
                                }
                            }];
}
...
///  @param page The number of the page returned, starting with 1 (optional, default to 1)
///
///  @returns SWGPageResourceDispositionResource_*
///
-(NSURLSessionTask*) getDispositionsUsingGET1WithVideoId: (NSNumber*) videoId
    size: (NSNumber*) size
    page: (NSNumber*) page
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceDispositionResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceDispositionResource_*)data, error);
                                }
                            }];
}
...
///  @param page The number of the page returned, starting with 1 (optional, default to 1)
///
///  @returns SWGPageResourceVideoRelationshipResource_*
///
-(NSURLSessionTask*) getRelatedUsingGETWithVideoId: (NSNumber*) videoId
    size: (NSNumber*) size
    page: (NSNumber*) page
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceVideoRelationshipResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceVideoRelationshipResource_*)data, error);
                                }
                            }];
}
...
///  @param page The number of the page returned, starting with 1 (optional, default to 1)
///
///  @returns SWGPageResourceVideoResource_*
///
-(NSURLSessionTask*) getUserVideosUsingGETWithUserId: (NSNumber*) userId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceVideoResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceVideoResource_*)data, error);
                                }
                            }];
}
...
///  @returns SWGVideoResource*
///
-(NSURLSessionTask*) getVideoUsingGETWithId: (NSNumber*) _id
    completionHandler: (void (^)(SWGVideoResource* output, NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
...
///  @returns void
///
-(NSURLSessionTask*) removeContributorUsingDELETEWithVideoId: (NSNumber*) videoId
    _id: (NSNumber*) _id
    completionHandler: (void (^)(NSError* error)) handler {
    // verify the required parameter 'videoId' is set
    if (videoId == nil) {
...
///  @returns void
///
-(NSURLSessionTask*) removeWhitelistUsingDELETEWithVideoId: (NSNumber*) videoId
    _id: (NSNumber*) _id
    completionHandler: (void (^)(NSError* error)) handler {
    // verify the required parameter 'videoId' is set
    if (videoId == nil) {
...
///  @returns SWGPageResourceVideoResource_*
///
-(NSURLSessionTask*) searchVideosUsingGETWithExcludeFlagged: (NSNumber*) excludeFlagged
...
///  @returns void
///
-(NSURLSessionTask*) updateCommentUsingPUT1WithVideoId: (NSNumber*) videoId
    _id: (NSNumber*) _id
...
///  @returns void
///
-(NSURLSessionTask*) updateRelationshipUsingPUT1WithVideoId: (NSNumber*) videoId
...
///  @returns void
///
-(NSURLSessionTask*) updateVideoUsingPUTWithId: (NSNumber*) _id
...
///  @returns void
///
-(NSURLSessionTask*) viewVideoUsingPOSTWithId: (NSNumber*) _id
    completionHandler: (void (^)(NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
