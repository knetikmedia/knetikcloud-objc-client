...
+ (instancetype)sharedAPI {
    static SWGMediaVideosApi *sharedAPI;
...
///  @returns void
///
-(NSNumber*) deleteRelationshipUsingDELETEWithVideoId: (NSNumber*) videoId
    _id: (NSNumber*) _id
    completionHandler: (void (^)(NSError* error)) handler {
    // verify the required parameter 'videoId' is set
    if (videoId == nil) {
...
///
///  @returns SWGPageCommentResource_*
///
-(NSNumber*) getCommentsUsingGET1WithVideoId: (NSNumber*) videoId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageCommentResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageCommentResource_*)data, error);
                                }
                           }
          ];
}
...
///  @param page The number of the page returned, starting with 1 (optional, default to 1)
///
///  @returns SWGPageDispositionResource_*
///
-(NSNumber*) getDispositionsUsingGET1WithVideoId: (NSNumber*) videoId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageDispositionResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageDispositionResource_*)data, error);
                                }
                           }
          ];
}
...
///  @param page The number of the page returned, starting with 1 (optional, default to 1)
///
///  @returns SWGPageVideoRelationshipResource_*
///
-(NSNumber*) getRelatedUsingGETWithVideoId: (NSNumber*) videoId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageVideoRelationshipResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageVideoRelationshipResource_*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getUserVideosUsingGETWithUserId: (NSNumber*) userId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageVideoResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageVideoResource_*)data, error);
                                }
                           }
          ];
}
...
///  @returns void
///
-(NSNumber*) updateRelationshipUsingPUTWithVideoId: (NSNumber*) videoId
