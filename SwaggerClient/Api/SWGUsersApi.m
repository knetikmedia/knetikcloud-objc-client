...
///  @returns void
///
-(NSURLSessionTask*) addTagUsingPOST1WithUserId: (NSNumber*) userId
    tag: (NSString*) tag
...
///
-(NSURLSessionTask*) createUserTemplateUsingPOSTWithUserTemplateResource: (SWGTemplateResource*) userTemplateResource
...
///  @returns void
///
-(NSURLSessionTask*) deleteUserTemplateUsingDELETEWithId: (NSString*) _id
...
///  @returns void
///
-(NSURLSessionTask*) doPasswordResetUsingPUTWithId: (NSNumber*) _id
...
///
-(NSURLSessionTask*) getTagsUsingGET3WithUserId: (NSNumber*) userId
...
///  @returns SWGTemplateResource*
///
-(NSURLSessionTask*) getUserTemplateUsingGETWithId: (NSString*) _id
    completionHandler: (void (^)(SWGTemplateResource* output, NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
...
///
-(NSURLSessionTask*) getUserTemplatesUsingGETWithSize: (NSNumber*) size
    page: (NSNumber*) page
...
///
-(NSURLSessionTask*) getUserUsingGETWithId: (NSString*) _id
...
///
-(NSURLSessionTask*) getUsersUsingGETWithFilterDisplayname: (NSString*) filterDisplayname
...
///  @returns void
///
-(NSURLSessionTask*) initiatePasswordResetUsingPOSTWithId: (NSNumber*) _id
    completionHandler: (void (^)(NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
...
///  @returns SWGUserResource*
///
-(NSURLSessionTask*) registerUserUsingPOSTWithUserResource: (SWGUserResource*) userResource
    completionHandler: (void (^)(SWGUserResource* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/users"];
...
///  @returns void
///
-(NSURLSessionTask*) removeTagUsingDELETE1WithUserId: (NSNumber*) userId
    tag: (NSString*) tag
    completionHandler: (void (^)(NSError* error)) handler {
    // verify the required parameter 'userId' is set
    if (userId == nil) {
...
///  @returns void
///
-(NSURLSessionTask*) setPasswordUsingPUTWithId: (NSNumber*) _id
...
///  @returns void
///
-(NSURLSessionTask*) updateUserTemplateUsingPUTWithId: (NSString*) _id
...
///  @returns void
///
-(NSURLSessionTask*) updateUserUsingPUTWithId: (NSString*) _id
