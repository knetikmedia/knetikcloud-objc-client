...
@interface SWGLogsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGLogsApi

NSString* kSWGLogsApiErrorDomain = @"SWGLogsApiErrorDomain";
NSInteger kSWGLogsApiMissingParamErrorCode = 234513;
...
///  @returns void
///
-(NSURLSessionTask*) addUserLogUsingPOSTWithLogEntry: (SWGUserActionLog*) logEntry
...
///
///  @returns SWGBreEventLog*
///
-(NSURLSessionTask*) getEventLogUsingGETWithId: (NSString*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGLogsApiErrorDomain code:kSWGLogsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGBreEventLog*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGBreEventLog*)data, error);
                                }
                            }];
}
...
///
///  @returns SWGPageResourceBreEventLog_*
///
-(NSURLSessionTask*) getEventsLogsUsingGETWithFilterStartDate: (NSString*) filterStartDate
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceBreEventLog_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceBreEventLog_*)data, error);
                                }
                            }];
}
...
///
///  @returns SWGForwardLog*
///
-(NSURLSessionTask*) getForwardLogUsingGETWithId: (NSString*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGForwardLog*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGForwardLog*)data, error);
                                }
                            }];
}
...
///  @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:DESC)
///
///  @returns SWGPageResourceForwardLog_*
///
-(NSURLSessionTask*) getForwardLogsUsingGETWithFilterStartDate: (NSString*) filterStartDate
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceForwardLog_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceForwardLog_*)data, error);
                                }
                            }];
}
...
///
///  @returns SWGUserActionLog*
///
-(NSURLSessionTask*) getUserLogsUsingGETWithId: (NSString*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGUserActionLog*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGUserActionLog*)data, error);
                                }
                            }];
}
...
///  @param page The number of the page returned, starting with 1 (optional, default to 1)
///
///  @returns SWGPageResourceUserActionLog_*
///
-(NSURLSessionTask*) getUserLogsUsingGET1WithFilterUser: (NSNumber*) filterUser
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceUserActionLog_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceUserActionLog_*)data, error);
                                }
                            }];
}
