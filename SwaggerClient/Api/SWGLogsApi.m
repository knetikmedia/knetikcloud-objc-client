...
-(NSNumber*) getEventsLogsUsingGETWithFilterStartDate: (NSString*) filterStartDate
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageBreEventLog_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageBreEventLog_*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getForwardLogsUsingGETWithFilterStartDate: (NSString*) filterStartDate
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageForwardLog_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageForwardLog_*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getUserLogsUsingGET1WithFilterUser: (NSNumber*) filterUser
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageUserActionLog_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageUserActionLog_*)data, error);
                                }
                           }
          ];
}
