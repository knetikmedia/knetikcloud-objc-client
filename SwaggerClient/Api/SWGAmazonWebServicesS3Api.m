#import "SWGAmazonWebServicesS3Api.h"
...
@interface SWGAmazonWebServicesS3Api ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGAmazonWebServicesS3Api

NSString* kSWGAmazonWebServicesS3ApiErrorDomain = @"SWGAmazonWebServicesS3ApiErrorDomain";
NSInteger kSWGAmazonWebServicesS3ApiMissingParamErrorCode = 234513;
