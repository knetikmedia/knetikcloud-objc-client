...
@interface SWGContentPollsApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGContentPollsApi

NSString* kSWGContentPollsApiErrorDomain = @"SWGContentPollsApiErrorDomain";
NSInteger kSWGContentPollsApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGContentPollsApi *sharedAPI;
...
///
///  @returns SWGPollResponseResource*
///
-(NSNumber*) answerPollUsingPOSTWithId: (NSString*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGContentPollsApiErrorDomain code:kSWGContentPollsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGPollResponseResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPollResponseResource*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) createPollUsingPOSTWithPollResource: (SWGPollResource*) pollResource
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPollResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPollResource*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getPollsUsingGETWithFilterCategory: (NSString*) filterCategory
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPagePollResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPagePollResource_*)data, error);
                                }
                           }
          ];
}
