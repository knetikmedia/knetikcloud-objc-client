#import "SWGAuthPermissionsApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGPagePermissionResource_.h"
#import "SWGPermissionResource.h"


@interface SWGAuthPermissionsApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGAuthPermissionsApi

NSString* kSWGAuthPermissionsApiErrorDomain = @"SWGAuthPermissionsApiErrorDomain";
NSInteger kSWGAuthPermissionsApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGAuthPermissionsApi *sharedAPI;
...
-(NSNumber*) createPermissionUsingPOSTWithPermissionResource: (SWGPermissionResource*) permissionResource
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGPermissionResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPermissionResource*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) deletePermissionUsingDELETEWithPermission: (NSString*) permission
    ...
    if (permission == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGAuthPermissionsApiErrorDomain code:kSWGAuthPermissionsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
...
///
///  @returns SWGPagePermissionResource_*
///
-(NSNumber*) getPermissionUsingGET1WithSize: (NSNumber*) size
    page: (NSNumber*) page
    order: (NSString*) order
    completionHandler: (void (^)(SWGPagePermissionResource_* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/auth/permissions"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPagePermissionResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPagePermissionResource_*)data, error);
                                }
                           }
          ];
}
