...
///
///  @returns SWGGroupMemberResource*
///
...
///
///  @returns SWGPageResourceGroupMemberResource_*
///
-(NSURLSessionTask*) getGroupMembersWithUniqueName: (NSString*) uniqueName
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceGroupMemberResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceGroupMemberResource_*)data, error);
                                }
                            }];
}
...
///
///  @returns SWGPageResourceGroupResource_*
///
-(NSURLSessionTask*) updateGroupsWithFilterName: (NSString*) filterName
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceGroupResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceGroupResource_*)data, error);
                                }
                            }];
}
