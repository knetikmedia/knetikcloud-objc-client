#import "SWGPaymentsAppleApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApplyPaymentRequest.h"


@interface SWGPaymentsAppleApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGPaymentsAppleApi

NSString* kSWGPaymentsAppleApiErrorDomain = @"SWGPaymentsAppleApiErrorDomain";
NSInteger kSWGPaymentsAppleApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGPaymentsAppleApi *sharedAPI;
