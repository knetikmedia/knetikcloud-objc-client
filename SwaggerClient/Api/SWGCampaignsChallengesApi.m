...
-(NSNumber*) getChallengeEventssUsingGETWithFilterStartDateMin: (NSNumber*) filterStartDateMin
    ...
    NSMutableDictionary* queryParams = [[NSMutableDictionary alloc] init];
    if (filterStartDateMin != nil) {
        queryParams[@"filter_start_date_min"] = filterStartDateMin;
    }
    if (filterStartDateMax != nil) {
        queryParams[@"filter_start_date_max"] = filterStartDateMax;
    }
    if (filterEndDateMin != nil) {
        queryParams[@"filter_end_date_min"] = filterEndDateMin;
    }
    if (filterEndDateMax != nil) {
        queryParams[@"filter_end_date_max"] = filterEndDateMax;
    }
