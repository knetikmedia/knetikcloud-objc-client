...
+ (instancetype)sharedAPI {
    static SWGCampaignsChallengesApi *sharedAPI;
...
///
///  @returns SWGPageBareChallengeActivityResource_*
///
-(NSNumber*) getActivitiesUsingGET1WithChallengeId: (NSNumber*) challengeId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageBareChallengeActivityResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageBareChallengeActivityResource_*)data, error);
                                }
                           }
          ];
}
...
///  @param order a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)
///
///  @returns SWGPageChallengeEventResource_*
///
-(NSNumber*) getChallengeEventssUsingGETWithFilterStartDate: (NSString*) filterStartDate
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageChallengeEventResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageChallengeEventResource_*)data, error);
                                }
                           }
          ];
}
...
///  @param order a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)
///
///  @returns SWGPageTemplateResource_*
///
...
///
///  @returns SWGPageChallengeResource_*
///
-(NSNumber*) getChallengesUsingGET1WithFilterTemplate: (NSNumber*) filterTemplate
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageChallengeResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageChallengeResource_*)data, error);
                                }
                           }
          ];
}
