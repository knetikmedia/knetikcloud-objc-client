#import "SWGCampaignsChallengesApi.h"
...
@interface SWGCampaignsChallengesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGCampaignsChallengesApi

NSString* kSWGCampaignsChallengesApiErrorDomain = @"SWGCampaignsChallengesApiErrorDomain";
NSInteger kSWGCampaignsChallengesApiMissingParamErrorCode = 234513;
...
///
///  @returns SWGChallengeActivityResource*
///
-(NSURLSessionTask*) createChallengeActivityUsingPOSTWithChallengeId: (NSNumber*) challengeId
    ...
    if (challengeId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGCampaignsChallengesApiErrorDomain code:kSWGCampaignsChallengesApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGChallengeActivityResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGChallengeActivityResource*)data, error);
                                }
                            }];
}
...
///
-(NSURLSessionTask*) createChallengeTemplateUsingPOSTWithChallengeTemplateResource: (SWGTemplateResource*) challengeTemplateResource
...
///
///  @returns SWGChallengeResource*
///
-(NSURLSessionTask*) createChallengeUsingPOSTWithChallengeResource: (SWGChallengeResource*) challengeResource
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGChallengeResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGChallengeResource*)data, error);
                                }
                            }];
}
...
///  @returns void
///
-(NSURLSessionTask*) deleteChallengeActivityUsingDELETEWithActivityId: (NSNumber*) activityId
...
///  @returns void
///
-(NSURLSessionTask*) deleteChallengeEventUsingDELETEWithId: (NSNumber*) _id
    completionHandler: (void (^)(NSError* error)) handler {
...
///  @returns void
///
-(NSURLSessionTask*) deleteChallengeTemplateUsingDELETEWithId: (NSString*) _id
...
///  @returns void
///
-(NSURLSessionTask*) deleteChallengeUsingDELETEWithId: (NSNumber*) _id
    completionHandler: (void (^)(NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
...
///
///  @returns SWGPageResourceBareChallengeActivityResource_*
///
-(NSURLSessionTask*) getActivitiesUsingGET1WithChallengeId: (NSNumber*) challengeId
    size: (NSNumber*) size
    page: (NSNumber*) page
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceBareChallengeActivityResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceBareChallengeActivityResource_*)data, error);
                                }
                            }];
}
...
///  @returns SWGChallengeActivityResource*
///
-(NSURLSessionTask*) getChallengeActivityUsingGETWithActivityId: (NSNumber*) activityId
    completionHandler: (void (^)(SWGChallengeActivityResource* output, NSError* error)) handler {
    // verify the required parameter 'activityId' is set
    if (activityId == nil) {
        NSParameterAssert(activityId);
...
///  @param _id The challenge event id 
///
///  @returns SWGChallengeEventResource*
///
-(NSURLSessionTask*) getChallengeEventUsingGETWithId: (NSNumber*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGChallengeEventResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGChallengeEventResource*)data, error);
                                }
                            }];
}
...
///  @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)
///
///  @returns SWGPageResourceChallengeEventResource_*
///
-(NSURLSessionTask*) getChallengeEventssUsingGETWithFilterStartDate: (NSString*) filterStartDate
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceChallengeEventResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceChallengeEventResource_*)data, error);
                                }
                            }];
}
...
///  @returns SWGTemplateResource*
///
-(NSURLSessionTask*) getChallengeTemplateUsingGETWithId: (NSString*) _id
    completionHandler: (void (^)(SWGTemplateResource* output, NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
...
///
-(NSURLSessionTask*) getChallengeTemplatesUsingGETWithSize: (NSNumber*) size
    page: (NSNumber*) page
    order: (NSString*) order
...
///  @returns SWGChallengeResource*
///
-(NSURLSessionTask*) getChallengeUsingGETWithId: (NSNumber*) _id
    completionHandler: (void (^)(SWGChallengeResource* output, NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
...
///
///  @returns SWGPageResourceChallengeResource_*
///
-(NSURLSessionTask*) getChallengesUsingGET1WithFilterTemplate: (NSNumber*) filterTemplate
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceChallengeResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceChallengeResource_*)data, error);
                                }
                            }];
}
...
///  @returns void
///
-(NSURLSessionTask*) updateChallengeActivityUsingPUTWithActivityId: (NSNumber*) activityId
    challengeId: (NSNumber*) challengeId
    challengeActivityResource: (SWGChallengeActivityResource*) challengeActivityResource
    completionHandler: (void (^)(NSError* error)) handler {
    // verify the required parameter 'activityId' is set
...
///  @returns void
///
-(NSURLSessionTask*) updateChallengeTemplateUsingPUTWithId: (NSString*) _id
...
///  @returns SWGChallengeResource*
///
-(NSURLSessionTask*) updateChallengeUsingPUTWithId: (NSNumber*) _id
