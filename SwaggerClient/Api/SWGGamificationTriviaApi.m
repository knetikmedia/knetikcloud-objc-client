...
///
///  @returns SWGPageImportJobResource_*
///
-(NSNumber*) getListUsingGET1WithFilterVendor: (NSString*) filterVendor
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageImportJobResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageImportJobResource_*)data, error);
                                }
                           }
          ];
}
...
///  @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)
///
///  @returns SWGPageQuestionTemplateResource_*
///
-(NSNumber*) getQuestionTemplatesUsingGETWithSize: (NSNumber*) size
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageQuestionTemplateResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageQuestionTemplateResource_*)data, error);
                                }
                           }
          ];
}
...
///  @param filterImportId Filter for questions from a specific import job (optional)
///
///  @returns SWGPageQuestionResource_*
///
-(NSNumber*) getQuestionsUsingGETWithSize: (NSNumber*) size
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageQuestionResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageQuestionResource_*)data, error);
                                }
                           }
          ];
}
