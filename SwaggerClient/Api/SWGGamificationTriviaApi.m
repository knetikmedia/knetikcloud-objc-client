...
///
///  @returns SWGAnswerResource*
///
-(NSURLSessionTask*) addAnswersUsingPOSTWithQuestionId: (NSString*) questionId
...
///  @returns void
///
-(NSURLSessionTask*) addTagUsingPOSTWithId: (NSString*) _id
    tag: (NSString*) tag
...
///  @returns NSNumber*
///
-(NSURLSessionTask*) batchAddTagUsingPOSTWithTag: (NSString*) tag
...
///  @returns NSNumber*
///
-(NSURLSessionTask*) batchRemoveTagUsingDELETEWithTag: (NSString*) tag
    filterSearch: (NSString*) filterSearch
    filterIdset: (NSString*) filterIdset
    filterCategory: (NSString*) filterCategory
    filterTag: (NSString*) filterTag
...
///  @returns NSNumber*
///
-(NSURLSessionTask*) bulkUpdateUsingPUTWithQuestion: (SWGQuestionResource*) question
    filterSearch: (NSString*) filterSearch
    filterIdset: (NSString*) filterIdset
    filterCategory: (NSString*) filterCategory
    filterTagset: (NSString*) filterTagset
...
///  @returns NSNumber*
///
-(NSURLSessionTask*) countQuestionsUsingGETWithFilterSearch: (NSString*) filterSearch
    filterIdset: (NSString*) filterIdset
    filterCategory: (NSString*) filterCategory
    filterTag: (NSString*) filterTag
    filterTagset: (NSString*) filterTagset
...
///
///  @returns SWGQuestionTemplateResource*
///
-(NSURLSessionTask*) createQuestionTemplateUsingPOSTWithQuestionTemplateResource: (SWGQuestionTemplateResource*) questionTemplateResource
...
///
///  @returns SWGQuestionResource*
///
-(NSURLSessionTask*) createQuestionUsingPOSTWithQuestion: (SWGQuestionResource*) question
...
///
///  @returns SWGImportJobResource*
///
-(NSURLSessionTask*) createUsingPOSTWithRequest: (SWGImportJobResource*) request
...
///  @returns void
///
-(NSURLSessionTask*) deleteQuestionTemplateUsingDELETEWithId: (NSString*) _id
...
///  @returns void
///
-(NSURLSessionTask*) deleteQuestionUsingDELETEWithId: (NSString*) _id
    completionHandler: (void (^)(NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
...
///  @returns void
///
-(NSURLSessionTask*) deleteUsingDELETEWithId: (NSNumber*) _id
    completionHandler: (void (^)(NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
...
///  @returns SWGAnswerResource*
///
-(NSURLSessionTask*) getAnswerUsingGETWithQuestionId: (NSString*) questionId
    _id: (NSString*) _id
    completionHandler: (void (^)(SWGAnswerResource* output, NSError* error)) handler {
    // verify the required parameter 'questionId' is set
    if (questionId == nil) {
...
///  @param questionId The id of the question 
///
///  @returns NSArray<SWGAnswerResource>*
///
-(NSURLSessionTask*) getAnswersUsingGETWithQuestionId: (NSString*) questionId
...
///
///  @returns SWGPageResourceImportJobResource_*
///
-(NSURLSessionTask*) getListUsingGET1WithFilterVendor: (NSString*) filterVendor
    filterCategory: (NSString*) filterCategory
...
///  @returns SWGQuestionTemplateResource*
///
-(NSURLSessionTask*) getQuestionTemplateUsingGETWithId: (NSString*) _id
    completionHandler: (void (^)(SWGQuestionTemplateResource* output, NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
...
///  @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)
///
///  @returns SWGPageResourceQuestionTemplateResource_*
///
-(NSURLSessionTask*) getQuestionTemplatesUsingGETWithSize: (NSNumber*) size
    page: (NSNumber*) page
    order: (NSString*) order
...
///  @returns SWGQuestionResource*
///
-(NSURLSessionTask*) getQuestionUsingGETWithId: (NSString*) _id
    completionHandler: (void (^)(SWGQuestionResource* output, NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
...
///
///  @returns NSArray<SWGDeltaResource>*
///
-(NSURLSessionTask*) getQuestionsDeltaUsingGETWithSince: (NSNumber*) since
...
///  @param filterImportId Filter for questions from a specific import job (optional)
///
///  @returns SWGPageResourceQuestionResource_*
///
-(NSURLSessionTask*) getQuestionsUsingGETWithSize: (NSNumber*) size
    page: (NSNumber*) page
    order: (NSString*) order
    filterSearch: (NSString*) filterSearch
    filterIdset: (NSString*) filterIdset
...
///
-(NSURLSessionTask*) getTagsUsingGET1WithId: (NSString*) _id
...
///
///  @returns SWGCollectionString_*
///
-(NSURLSessionTask*) getTagsUsingGET2WithFilterSearch: (NSString*) filterSearch
    filterCategory: (NSString*) filterCategory
    filterImportId: (NSNumber*) filterImportId
...
///  @returns SWGImportJobResource*
///
-(NSURLSessionTask*) getUsingGETWithId: (NSNumber*) _id
    completionHandler: (void (^)(SWGImportJobResource* output, NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
...
///  @returns void
///
-(NSURLSessionTask*) removeAnswersUsingDELETEWithQuestionId: (NSString*) questionId
    _id: (NSString*) _id
    completionHandler: (void (^)(NSError* error)) handler {
    // verify the required parameter 'questionId' is set
    if (questionId == nil) {
...
///  @returns void
///
-(NSURLSessionTask*) removeTagUsingDELETEWithId: (NSString*) _id
    tag: (NSString*) tag
    completionHandler: (void (^)(NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
...
///  @returns SWGImportJobResource*
///
-(NSURLSessionTask*) startProcessUsingPOSTWithId: (NSNumber*) _id
...
///  @returns void
///
-(NSURLSessionTask*) updateAnswerUsingPUTWithQuestionId: (NSString*) questionId
    _id: (NSString*) _id
    answer: (SWGAnswerResource*) answer
    completionHandler: (void (^)(NSError* error)) handler {
    // verify the required parameter 'questionId' is set
...
///  @returns void
///
-(NSURLSessionTask*) updateQuestionTemplateUsingPUTWithId: (NSString*) _id
...
///  @returns SWGQuestionResource*
///
-(NSURLSessionTask*) updateQuestionUsingPUTWithId: (NSString*) _id
...
///  @returns SWGImportJobResource*
///
-(NSURLSessionTask*) updateUsingPUTWithId: (NSNumber*) _id
