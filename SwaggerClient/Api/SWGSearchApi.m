...
///  @returns void
///
-(NSURLSessionTask*) externalAddUsingPOSTWithType: (NSString*) type
    _id: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/search/index/{type}/{id}"];
...
///  @returns void
///
-(NSURLSessionTask*) externalDeleteAllUsingDELETEWithType: (NSString*) type
    completionHandler: (void (^)(NSError* error)) handler {
    // verify the required parameter 'type' is set
    if (type == nil) {
        NSParameterAssert(type);
...
///  @returns void
///
-(NSURLSessionTask*) externalDeleteUsingDELETEWithType: (NSString*) type
    _id: (NSString*) _id
    completionHandler: (void (^)(NSError* error)) handler {
    // verify the required parameter 'type' is set
    if (type == nil) {
...
///  @returns void
///
-(NSURLSessionTask*) externalRegisterUsingPOSTWithMappings: (NSArray<SWGSearchReferenceMapping>*) mappings
    completionHandler: (void (^)(NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/search/mappings"];
...
///
///  @returns SWGPageResourceMapStringObject_*
///
-(NSURLSessionTask*) searchUsingPOSTWithType: (NSString*) type
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceMapStringObject_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceMapStringObject_*)data, error);
                                }
                            }];
}
