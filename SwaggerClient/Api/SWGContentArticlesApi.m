#import "SWGContentArticlesApi.h"
...
@interface SWGContentArticlesApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGContentArticlesApi

NSString* kSWGContentArticlesApiErrorDomain = @"SWGContentArticlesApiErrorDomain";
NSInteger kSWGContentArticlesApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGContentArticlesApi *sharedAPI;
...
-(NSNumber*) createArticleUsingPOSTWithArticleResource: (SWGArticleResource*) articleResource
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGArticleResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGArticleResource*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) deleteArticleTemplateUsingDELETEWithId: (NSString*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGContentArticlesApiErrorDomain code:kSWGContentArticlesApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
...
///  @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)
///
///  @returns SWGPageArticleResource_*
///
-(NSNumber*) getArticlesUsingGETWithFilterCategory: (NSString*) filterCategory
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageArticleResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageArticleResource_*)data, error);
                                }
                           }
          ];
}
