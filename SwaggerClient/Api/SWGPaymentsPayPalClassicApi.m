#import "SWGPaymentsPayPalClassicApi.h"
...
@interface SWGPaymentsPayPalClassicApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGPaymentsPayPalClassicApi

NSString* kSWGPaymentsPayPalClassicApiErrorDomain = @"SWGPaymentsPayPalClassicApiErrorDomain";
NSInteger kSWGPaymentsPayPalClassicApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGPaymentsPayPalClassicApi *sharedAPI;
