...
@interface SWGStoreCouponsApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGStoreCouponsApi

NSString* kSWGStoreCouponsApiErrorDomain = @"SWGStoreCouponsApiErrorDomain";
NSInteger kSWGStoreCouponsApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGStoreCouponsApi *sharedAPI;
...
-(NSNumber*) createCouponItemUsingPOSTWithCouponItem: (SWGCouponItem*) couponItem
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGCouponItem*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGCouponItem*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) deleteCouponItemUsingDELETEWithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGStoreCouponsApiErrorDomain code:kSWGStoreCouponsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
