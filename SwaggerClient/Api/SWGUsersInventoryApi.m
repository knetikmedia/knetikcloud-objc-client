...
///
///  @returns SWGPageResourceEntitlementItem_*
///
-(NSURLSessionTask*) getEntitlementItemsWithSize: (NSNumber*) size
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceEntitlementItem_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceEntitlementItem_*)data, error);
                                }
                            }];
}
...
///
///  @returns SWGPageResourceUserInventoryResource_*
///
-(NSURLSessionTask*) getUserInventoriesWithId: (NSNumber*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceUserInventoryResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceUserInventoryResource_*)data, error);
                                }
                            }];
}
...
///  @param page The number of the page returned, starting with 1 (optional, default to 1)
///
///  @returns SWGPageResourceUserItemLogResource_*
///
-(NSURLSessionTask*) getUserInventoryLogWithUserId: (NSString*) userId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceUserItemLogResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceUserItemLogResource_*)data, error);
                                }
                            }];
}
