...
@interface SWGUsersInventoryApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGUsersInventoryApi

NSString* kSWGUsersInventoryApiErrorDomain = @"SWGUsersInventoryApiErrorDomain";
NSInteger kSWGUsersInventoryApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGUsersInventoryApi *sharedAPI;
...
-(NSNumber*) addItemUsingPOST1WithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGUsersInventoryApiErrorDomain code:kSWGUsersInventoryApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
...
-(NSNumber*) createItemUsingPOSTWithEntitlementItem: (SWGEntitlementItem*) entitlementItem
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGEntitlementItem*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGEntitlementItem*)data, error);
                                }
                           }
          ];
}
...
///
///  @returns SWGPageEntitlementItem_*
///
-(NSNumber*) getCurrenciesUsingGET1WithSize: (NSNumber*) size
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageEntitlementItem_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageEntitlementItem_*)data, error);
                                }
                           }
          ];
}
...
///  @param order a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)
///
///  @returns SWGPageItemTemplateResource_*
///
-(NSNumber*) getEntitlementTemplatesUsingGETWithSize: (NSNumber*) size
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageItemTemplateResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageItemTemplateResource_*)data, error);
                                }
                           }
          ];
}
...
///
///  @returns SWGPageUserInventoryResource_*
///
-(NSNumber*) getInventoryListUsingGETWithInactive: (NSNumber*) inactive
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageUserInventoryResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageUserInventoryResource_*)data, error);
                                }
                           }
          ];
}
...
///
///  @returns SWGUserInventoryResource*
///
-(NSNumber*) getInventoryUsingGETWithUserId: (NSNumber*) userId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGUserInventoryResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGUserInventoryResource*)data, error);
                                }
                           }
          ];
}
...
///  @param page The number of the page returned, starting with 1 (optional, default to 1)
///
///  @returns SWGPageUserItemLogResource_*
///
-(NSNumber*) getUserInventoryLogUsingGETWithUserId: (NSString*) userId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageUserItemLogResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageUserItemLogResource_*)data, error);
                                }
                           }
          ];
}
