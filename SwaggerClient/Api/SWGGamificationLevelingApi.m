...
-(NSNumber*) getLevelsUsingGETWithFilterName: (NSString*) filterName
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceLevelingResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceLevelingResource_*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getUserLevelsUsingGETWithUserId: (NSNumber*) userId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceUserLevelingResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceUserLevelingResource_*)data, error);
                                }
                           }
          ];
}
