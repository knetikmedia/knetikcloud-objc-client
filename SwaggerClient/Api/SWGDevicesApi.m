...
+ (instancetype)sharedAPI {
    static SWGDevicesApi *sharedAPI;
...
-(NSNumber*) createDeviceUsingPOSTWithDevice: (SWGDeviceResource*) device
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGDeviceResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGDeviceResource*)data, error);
                                }
                           }
          ];
}
...
///
///  @returns SWGPageDeviceResource_*
///
-(NSNumber*) getDevicesUsingGETWithFilterMake: (NSString*) filterMake
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageDeviceResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageDeviceResource_*)data, error);
                                }
                           }
          ];
}
