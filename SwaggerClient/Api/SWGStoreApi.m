...
///
///  @returns SWGStoreItemTemplateResource*
///
-(NSURLSessionTask*) createItemTemplateUsingPOSTWithItemTemplateResource: (SWGStoreItemTemplateResource*) itemTemplateResource
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGStoreItemTemplateResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGStoreItemTemplateResource*)data, error);
                                }
                            }];
}
...
///
///  @returns SWGStoreItem*
///
-(NSURLSessionTask*) createStoreItemExternalUsingPOSTWithStoreItem: (SWGStoreItem*) storeItem
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGStoreItem*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGStoreItem*)data, error);
                                }
                            }];
}
...
///  @returns void
///
-(NSURLSessionTask*) deleteItemTemplateUsingDELETEWithId: (NSString*) _id
...
///  @returns void
///
-(NSURLSessionTask*) deleteStoreItemUsingDELETE1WithId: (NSNumber*) _id
    completionHandler: (void (^)(NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
...
///  @returns SWGStoreItemTemplateResource*
///
-(NSURLSessionTask*) getItemTemplateUsingGETWithId: (NSString*) _id
    completionHandler: (void (^)(SWGStoreItemTemplateResource* output, NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
...
///
///  @returns SWGPageResourceStoreItemTemplateResource_*
///
-(NSURLSessionTask*) getItemTemplatesUsingGETWithSize: (NSNumber*) size
    page: (NSNumber*) page
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceStoreItemTemplateResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceStoreItemTemplateResource_*)data, error);
                                }
                            }];
}
...
///  @returns SWGStoreItem*
///
-(NSURLSessionTask*) getStoreItemUsingGET1WithId: (NSNumber*) _id
    completionHandler: (void (^)(SWGStoreItem* output, NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
...
///  @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)
///
///  @returns SWGPageResourceStoreItem_*
///
-(NSURLSessionTask*) getStoreItemsUsingGETWithFilterNameSearch: (NSString*) filterNameSearch
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceStoreItem_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceStoreItem_*)data, error);
                                }
                            }];
}
...
///  @returns SWGPageResourceStoreItem_*
///
-(NSURLSessionTask*) getUsingGET2WithLimit: (NSNumber*) limit
    page: (NSNumber*) page
...
///  @returns void
///
-(NSURLSessionTask*) updateItemTemplateUsingPUTWithId: (NSString*) _id
...
///  @returns void
///
-(NSURLSessionTask*) updateStoreItemExternalUsingPUTWithId: (NSNumber*) _id
