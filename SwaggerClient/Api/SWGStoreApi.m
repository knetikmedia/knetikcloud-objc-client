...
#import "SWGBehaviorDefinitionResource.h"
...
/// 
///  @returns NSArray<SWGBehaviorDefinitionResource>*
///
-(NSURLSessionTask*) getBehaviorsWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<SWGBehaviorDefinitionResource>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<SWGBehaviorDefinitionResource>*)data, error);
                                }
                            }];
}
