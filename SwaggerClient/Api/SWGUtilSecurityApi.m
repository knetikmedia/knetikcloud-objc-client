...
+ (instancetype)sharedAPI {
    static SWGUtilSecurityApi *sharedAPI;
...
///
///  @returns SWGPageLocationLogResource_*
///
-(NSNumber*) getUserLocationLogUsingGETWithUserId: (NSNumber*) userId
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGPageLocationLogResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageLocationLogResource_*)data, error);
                                }
                           }
          ];
}
