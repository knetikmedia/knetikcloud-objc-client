...
+ (instancetype)sharedAPI {
    static SWGPaymentsApi *sharedAPI;
...
///
///  @returns SWGPaymentMethodResource*
///
...
///
///  @returns NSArray<SWGPaymentMethodResource>*
///
-(NSNumber*) getPaymentMethodsUsingGETWithUserId: (NSNumber*) userId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<SWGPaymentMethodResource>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<SWGPaymentMethodResource>*)data, error);
                                }
                           }
          ];
}
...
///
///  @returns SWGPaymentAuthorizationResource*
///
-(NSNumber*) paymentAuthorizationUsingPOSTWithRequest: (SWGPaymentAuthorizationResource*) request
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPaymentAuthorizationResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPaymentAuthorizationResource*)data, error);
                                }
                           }
          ];
}
