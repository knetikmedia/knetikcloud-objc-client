...
///
///  @returns SWGPageRevenueCountryReportResource_*
///
-(NSNumber*) executiveRevenueCountrySalesUsingGETWithCurrencyCode: (NSString*) currencyCode
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGPageRevenueCountryReportResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageRevenueCountryReportResource_*)data, error);
                                }
                           }
          ];
}
...
///  @param page The number of the page returned, starting with 1 (optional, default to 1)
///
///  @returns SWGPageRevenueProductReportResource_*
///
-(NSNumber*) executiveRevenueProductSalesUsingGETWithCurrencyCode: (NSString*) currencyCode
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageRevenueProductReportResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageRevenueProductReportResource_*)data, error);
                                }
                           }
          ];
}
