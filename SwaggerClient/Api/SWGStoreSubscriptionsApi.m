...
+ (instancetype)sharedAPI {
    static SWGStoreSubscriptionsApi *sharedAPI;
...
///
///  @returns SWGPageSubscriptionTemplateResource_*
///
-(NSNumber*) getSubscriptionTemplatesUsingGETWithSize: (NSNumber*) size
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageSubscriptionTemplateResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageSubscriptionTemplateResource_*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) listBillingReportsUsingGETWithSize: (NSNumber*) size
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/subscriptions/reports"];
...
///  @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)
///
///  @returns SWGPageSubscriptionResource_*
///
-(NSNumber*) listSubscriptionsUsingGETWithSize: (NSNumber*) size
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageSubscriptionResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageSubscriptionResource_*)data, error);
                                }
                           }
          ];
}
