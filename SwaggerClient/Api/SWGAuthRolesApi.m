...
///
///  @returns NSArray<SWGRoleResource>*
///
...
///
///  @returns SWGPageResourceRoleResource_*
///
-(NSURLSessionTask*) getRolesWithSize: (NSNumber*) size
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceRoleResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceRoleResource_*)data, error);
                                }
                            }];
}
