#import "SWGBRERuleEngineEventsApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGBreEvent.h"
#import "SWGOAuth2Authentication.h"


@interface SWGBRERuleEngineEventsApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGBRERuleEngineEventsApi

NSString* kSWGBRERuleEngineEventsApiErrorDomain = @"SWGBRERuleEngineEventsApiErrorDomain";
NSInteger kSWGBRERuleEngineEventsApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGBRERuleEngineEventsApi *sharedAPI;
