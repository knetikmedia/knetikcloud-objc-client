...
@interface SWGInvoicesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGInvoicesApi

NSString* kSWGInvoicesApiErrorDomain = @"SWGInvoicesApiErrorDomain";
NSInteger kSWGInvoicesApiMissingParamErrorCode = 234513;
...
///
///  @returns NSArray<SWGInvoiceResource>*
///
-(NSURLSessionTask*) createInvoiceUsingPOSTWithReq: (SWGInvoiceCreateRequest*) req
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"NSArray<SWGInvoiceResource>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<SWGInvoiceResource>*)data, error);
                                }
                            }];
}
...
///
///  @returns SWGPageResourceInvoiceResource_*
///
-(NSURLSessionTask*) getInvoiceHistoryUsingGETWithFilterUser: (NSNumber*) filterUser
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceInvoiceResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceInvoiceResource_*)data, error);
                                }
                            }];
}
...
///
-(NSURLSessionTask*) getInvoiceUsingGETWithId: (NSNumber*) _id
...
///  @param page The number of the page returned, starting with 1 (optional, default to 1)
///
///  @returns SWGPageResourceInvoiceLogEntry_*
///
-(NSURLSessionTask*) getLogsUsingGETWithId: (NSNumber*) _id
    size: (NSNumber*) size
    page: (NSNumber*) page
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageResourceInvoiceLogEntry_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageResourceInvoiceLogEntry_*)data, error);
                                }
                            }];
}
...
///
-(NSURLSessionTask*) listFulFillmentStatusesUsingGETWithCompletionHandler: 
...
///  @returns NSArray<NSString*>*
///
-(NSURLSessionTask*) listPaymentStatusesUsingGETWithCompletionHandler: 
    (void (^)(NSArray<NSString*>* output, NSError* error)) handler {
...
///  @returns void
///
-(NSURLSessionTask*) payInvoiceUsingPOSTWithId: (NSNumber*) _id
...
///  @returns void
///
-(NSURLSessionTask*) setItemFulfillmentStatusUsingPUTWithId: (NSNumber*) _id
    sku: (NSString*) sku
...
///  @returns void
///
-(NSURLSessionTask*) setOrderNotesUsingPUTWithId: (NSNumber*) _id
...
///  @returns void
///
-(NSURLSessionTask*) updateBillingInfoUsingPUTWithId: (NSNumber*) _id
