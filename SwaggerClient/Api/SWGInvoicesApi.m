...
+ (instancetype)sharedAPI {
    static SWGInvoicesApi *sharedAPI;
...
///
///  @returns SWGPageInvoiceResource_*
///
-(NSNumber*) getInvoiceHistoryUsingGETWithFilterUser: (NSNumber*) filterUser
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageInvoiceResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageInvoiceResource_*)data, error);
                                }
                           }
          ];
}
...
///  @param page The number of the page returned, starting with 1 (optional, default to 1)
///
///  @returns SWGPageInvoiceLogEntry_*
///
-(NSNumber*) getLogsUsingGETWithId: (NSNumber*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageInvoiceLogEntry_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageInvoiceLogEntry_*)data, error);
                                }
                           }
          ];
}
