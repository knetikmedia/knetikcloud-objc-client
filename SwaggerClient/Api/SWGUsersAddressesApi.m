#import "SWGUsersAddressesApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGPageSavedAddressResource_.h"
#import "SWGSavedAddressResource.h"


@interface SWGUsersAddressesApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGUsersAddressesApi

NSString* kSWGUsersAddressesApiErrorDomain = @"SWGUsersAddressesApiErrorDomain";
NSInteger kSWGUsersAddressesApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGUsersAddressesApi *sharedAPI;
...
///
///  @returns SWGSavedAddressResource*
///
-(NSNumber*) createAddressUsingPOSTWithUserId: (NSString*) userId
    ...
    if (userId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGUsersAddressesApiErrorDomain code:kSWGUsersAddressesApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/users/{user_id}/addresses"];
    ...
    bodyParam = savedAddressResource;
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGSavedAddressResource*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGSavedAddressResource*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) deleteAddressUsingDELETEWithUserId: (NSString*) userId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/users/{user_id}/addresses/{id}"];
...
///
///  @returns SWGPageSavedAddressResource_*
///
-(NSNumber*) getAddressesUsingGETWithUserId: (NSString*) userId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPageSavedAddressResource_*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPageSavedAddressResource_*)data, error);
                                }
                           }
          ];
}
