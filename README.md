...
#import <JSAPI/JSAPIBreCategoryResource.h>
...
#import <JSAPI/JSAPIGooglePaymentRequest.h>
...
#import <JSAPI/JSAPIPageResourceBreCategoryResource_.h>
...
#import <JSAPI/JSAPIPageResourceTopicSubscriberResource_.h>
...
#import <JSAPI/JSAPIValueWrapperString_.h>
...
#import <JSAPI/JSAPIBRERuleEngineActionsApi.h>
#import <JSAPI/JSAPIBRERuleEngineCategoriesApi.h>
#import <JSAPI/JSAPIBRERuleEngineEventsApi.h>
#import <JSAPI/JSAPIBRERuleEngineExpressionsApi.h>
#import <JSAPI/JSAPIBRERuleEngineGlobalsApi.h>
#import <JSAPI/JSAPIBRERuleEngineRulesApi.h>
#import <JSAPI/JSAPIBRERuleEngineTriggersApi.h>
#import <JSAPI/JSAPIBRERuleEngineVariablesApi.h>
...
#import <JSAPI/JSAPIContentPollsApi.h>
...
*JSAPIBRERuleEngineActionsApi* | [**getBREActions**](docs/JSAPIBRERuleEngineActionsApi.md#getbreactions) | **GET** /bre/actions | Get a list of available actions
*JSAPIBRERuleEngineCategoriesApi* | [**createBRECategoryTemplate**](docs/JSAPIBRERuleEngineCategoriesApi.md#createbrecategorytemplate) | **POST** /bre/categories/templates | Create a BRE category template
*JSAPIBRERuleEngineCategoriesApi* | [**deleteBRECategoryTemplate**](docs/JSAPIBRERuleEngineCategoriesApi.md#deletebrecategorytemplate) | **DELETE** /bre/categories/templates/{id} | Delete a BRE category template
*JSAPIBRERuleEngineCategoriesApi* | [**getBRECategories**](docs/JSAPIBRERuleEngineCategoriesApi.md#getbrecategories) | **GET** /bre/categories | List categories
*JSAPIBRERuleEngineCategoriesApi* | [**getBRECategory**](docs/JSAPIBRERuleEngineCategoriesApi.md#getbrecategory) | **GET** /bre/categories/{name} | Get a single category
*JSAPIBRERuleEngineCategoriesApi* | [**getBRECategoryTemplate**](docs/JSAPIBRERuleEngineCategoriesApi.md#getbrecategorytemplate) | **GET** /bre/categories/templates/{id} | Get a single BRE category template
*JSAPIBRERuleEngineCategoriesApi* | [**getBRECategoryTemplates**](docs/JSAPIBRERuleEngineCategoriesApi.md#getbrecategorytemplates) | **GET** /bre/categories/templates | List and search BRE category templates
*JSAPIBRERuleEngineCategoriesApi* | [**updateBRECategory**](docs/JSAPIBRERuleEngineCategoriesApi.md#updatebrecategory) | **PUT** /bre/categories/{name} | Update a category
*JSAPIBRERuleEngineCategoriesApi* | [**updateBRECategoryTemplate**](docs/JSAPIBRERuleEngineCategoriesApi.md#updatebrecategorytemplate) | **PUT** /bre/categories/templates/{id} | Update a BRE category template
*JSAPIBRERuleEngineEventsApi* | [**sendBREEvent**](docs/JSAPIBRERuleEngineEventsApi.md#sendbreevent) | **POST** /bre/events | Fire a new event, based on an existing trigger
*JSAPIBRERuleEngineExpressionsApi* | [**getBREExpression**](docs/JSAPIBRERuleEngineExpressionsApi.md#getbreexpression) | **GET** /bre/expressions/{type} | Lookup a specific expression
*JSAPIBRERuleEngineExpressionsApi* | [**getBREExpressions**](docs/JSAPIBRERuleEngineExpressionsApi.md#getbreexpressions) | **GET** /bre/expressions | Get a list of supported expressions to use in conditions or actions
*JSAPIBRERuleEngineExpressionsApi* | [**getExpressionAsText**](docs/JSAPIBRERuleEngineExpressionsApi.md#getexpressionastext) | **POST** /bre/expressions | Returns the textual representation of an expression
*JSAPIBRERuleEngineGlobalsApi* | [**createBREGlobal**](docs/JSAPIBRERuleEngineGlobalsApi.md#createbreglobal) | **POST** /bre/globals/definitions | Create a global definition
*JSAPIBRERuleEngineGlobalsApi* | [**deleteBREGlobal**](docs/JSAPIBRERuleEngineGlobalsApi.md#deletebreglobal) | **DELETE** /bre/globals/definitions/{id} | Delete a global
*JSAPIBRERuleEngineGlobalsApi* | [**getBREGlobal**](docs/JSAPIBRERuleEngineGlobalsApi.md#getbreglobal) | **GET** /bre/globals/definitions/{id} | Get a single global definition
*JSAPIBRERuleEngineGlobalsApi* | [**getBREGlobals**](docs/JSAPIBRERuleEngineGlobalsApi.md#getbreglobals) | **GET** /bre/globals/definitions | List global definitions
*JSAPIBRERuleEngineGlobalsApi* | [**updateBREGlobal**](docs/JSAPIBRERuleEngineGlobalsApi.md#updatebreglobal) | **PUT** /bre/globals/definitions/{id} | Update a global definition
*JSAPIBRERuleEngineRulesApi* | [**createBRERule**](docs/JSAPIBRERuleEngineRulesApi.md#createbrerule) | **POST** /bre/rules | Create a rule
*JSAPIBRERuleEngineRulesApi* | [**deleteBRERule**](docs/JSAPIBRERuleEngineRulesApi.md#deletebrerule) | **DELETE** /bre/rules/{id} | Delete a rule
*JSAPIBRERuleEngineRulesApi* | [**getBREExpressionAsString**](docs/JSAPIBRERuleEngineRulesApi.md#getbreexpressionasstring) | **POST** /bre/rules/expression-as-string | Returns a string representation of the provided expression
*JSAPIBRERuleEngineRulesApi* | [**getBRERule**](docs/JSAPIBRERuleEngineRulesApi.md#getbrerule) | **GET** /bre/rules/{id} | Get a single rule
*JSAPIBRERuleEngineRulesApi* | [**getBRERules**](docs/JSAPIBRERuleEngineRulesApi.md#getbrerules) | **GET** /bre/rules | List rules
*JSAPIBRERuleEngineRulesApi* | [**setBRERule**](docs/JSAPIBRERuleEngineRulesApi.md#setbrerule) | **PUT** /bre/rules/{id}/enabled | Enable or disable a rule
*JSAPIBRERuleEngineRulesApi* | [**updateBRERule**](docs/JSAPIBRERuleEngineRulesApi.md#updatebrerule) | **PUT** /bre/rules/{id} | Update a rule
*JSAPIBRERuleEngineTriggersApi* | [**createBRETrigger**](docs/JSAPIBRERuleEngineTriggersApi.md#createbretrigger) | **POST** /bre/triggers | Create a trigger
*JSAPIBRERuleEngineTriggersApi* | [**deleteBRETrigger**](docs/JSAPIBRERuleEngineTriggersApi.md#deletebretrigger) | **DELETE** /bre/triggers/{event_name} | Delete a trigger
*JSAPIBRERuleEngineTriggersApi* | [**getBRETrigger**](docs/JSAPIBRERuleEngineTriggersApi.md#getbretrigger) | **GET** /bre/triggers/{event_name} | Get a single trigger
*JSAPIBRERuleEngineTriggersApi* | [**getBRETriggers**](docs/JSAPIBRERuleEngineTriggersApi.md#getbretriggers) | **GET** /bre/triggers | List triggers
*JSAPIBRERuleEngineTriggersApi* | [**updateBRETrigger**](docs/JSAPIBRERuleEngineTriggersApi.md#updatebretrigger) | **PUT** /bre/triggers/{event_name} | Update a trigger
*JSAPIBRERuleEngineVariablesApi* | [**getBREVariableTypes**](docs/JSAPIBRERuleEngineVariablesApi.md#getbrevariabletypes) | **GET** /bre/variable-types | Get a list of variable types available
*JSAPIBRERuleEngineVariablesApi* | [**getBREVariableValues**](docs/JSAPIBRERuleEngineVariablesApi.md#getbrevariablevalues) | **GET** /bre/variable-types/{name}/values | List valid values for a type
...
*JSAPIChatApi* | [**sendMessage**](docs/JSAPIChatApi.md#sendmessage) | **POST** /chat/messages | Send a message
...
*JSAPIContentPollsApi* | [**answerPoll**](docs/JSAPIContentPollsApi.md#answerpoll) | **POST** /media/polls/{id}/response | Add your vote to a poll
*JSAPIContentPollsApi* | [**createPoll**](docs/JSAPIContentPollsApi.md#createpoll) | **POST** /media/polls | Create a new poll
*JSAPIContentPollsApi* | [**createPollTemplate**](docs/JSAPIContentPollsApi.md#createpolltemplate) | **POST** /media/polls/templates | Create a poll template
*JSAPIContentPollsApi* | [**deletePoll**](docs/JSAPIContentPollsApi.md#deletepoll) | **DELETE** /media/polls/{id} | Delete an existing poll
*JSAPIContentPollsApi* | [**deletePollTemplate**](docs/JSAPIContentPollsApi.md#deletepolltemplate) | **DELETE** /media/polls/templates/{id} | Delete a poll template
*JSAPIContentPollsApi* | [**getPoll**](docs/JSAPIContentPollsApi.md#getpoll) | **GET** /media/polls/{id} | Get a single poll
*JSAPIContentPollsApi* | [**getPollAnswer**](docs/JSAPIContentPollsApi.md#getpollanswer) | **GET** /media/polls/{id}/response | Get poll answer
*JSAPIContentPollsApi* | [**getPollTemplate**](docs/JSAPIContentPollsApi.md#getpolltemplate) | **GET** /media/polls/templates/{id} | Get a single poll template
*JSAPIContentPollsApi* | [**getPollTemplates**](docs/JSAPIContentPollsApi.md#getpolltemplates) | **GET** /media/polls/templates | List and search poll templates
*JSAPIContentPollsApi* | [**getPolls**](docs/JSAPIContentPollsApi.md#getpolls) | **GET** /media/polls | List and search polls
*JSAPIContentPollsApi* | [**updatePoll**](docs/JSAPIContentPollsApi.md#updatepoll) | **PUT** /media/polls/{id} | Update an existing poll
*JSAPIContentPollsApi* | [**updatePollTemplate**](docs/JSAPIContentPollsApi.md#updatepolltemplate) | **PUT** /media/polls/templates/{id} | Update a poll template
...
*JSAPIMessagingApi* | [**sendMessage1**](docs/JSAPIMessagingApi.md#sendmessage1) | **POST** /messaging/message | Send a message
...
*JSAPIMessagingTopicsApi* | [**getTopicSubscribers**](docs/JSAPIMessagingTopicsApi.md#gettopicsubscribers) | **GET** /messaging/topics/{id}/subscribers | Get all subscribers to a topic
...
*JSAPIUsersApi* | [**getDirectMessages1**](docs/JSAPIUsersApi.md#getdirectmessages1) | **GET** /users/users/{recipient_id}/messages | Get a list of direct messages with this user
...
## Documentation For Models
 ...
 - [JSAPIBreCategoryResource](docs/JSAPIBreCategoryResource.md)
 ...
 - [JSAPIGooglePaymentRequest](docs/JSAPIGooglePaymentRequest.md)
 ...
 - [JSAPIPageResourceBreCategoryResource_](docs/JSAPIPageResourceBreCategoryResource_.md)
 ...
 - [JSAPIPageResourceTopicSubscriberResource_](docs/JSAPIPageResourceTopicSubscriberResource_.md)
 ...
 - [JSAPIValueWrapperString_](docs/JSAPIValueWrapperString_.md)
