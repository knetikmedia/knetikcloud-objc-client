...
*SWGUsersGroupsApi* | [**deleteGroupMemberUsingDELETE**](docs/SWGUsersGroupsApi.md#deletegroupmemberusingdelete) | **DELETE** /users/groups/{unique_name}/members/{user_id} | Removes a user from a group
...
*SWGUsersGroupsApi* | [**deleteGroupUsingDELETE**](docs/SWGUsersGroupsApi.md#deletegroupusingdelete) | **DELETE** /users/groups/{unique_name} | Removes a group from the system IF no resources are attached to it
*SWGUsersGroupsApi* | [**getGroupListUsingGET**](docs/SWGUsersGroupsApi.md#getgrouplistusingget) | **GET** /users/{user_id}/groups | List groups a user is in
*SWGUsersGroupsApi* | [**getGroupMemberUsingGET**](docs/SWGUsersGroupsApi.md#getgroupmemberusingget) | **GET** /users/groups/{unique_name}/members/{user_id} | Get a user from a group
...
*SWGUsersInventoryApi* | [**grantEntitlementUsingPOST**](docs/SWGUsersInventoryApi.md#grantentitlementusingpost) | **POST** /users/{user_id}/entitlements/ | Grant an entitlement
...
*SWGUtilVersionApi* | [**getUsingGET3**](docs/SWGUtilVersionApi.md#getusingget3) | **GET** /version | Get current version info
