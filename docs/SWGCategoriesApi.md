...
[apiInstance getCategoriesUsingGET1WithFilterSearch:filterSearch
              ...
              page:page
              order:order
          completionHandler: ^(SWGPageCategoryResource_* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
...
[**SWGPageCategoryResource_***](SWGPageCategoryResource_.md)
...
[apiInstance getTagsUsingGETWithSize:size
              page:page
              order:order
          completionHandler: ^(SWGPageString_* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
...
[**SWGPageString_***](SWGPageString_.md)
