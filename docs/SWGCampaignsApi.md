...
------------- | ------------- | -------------
[**addChallengeToCampaign**](SWGCampaignsApi.md#addchallengetocampaign) | **POST** /campaigns/{id}/challenges | Add a challenge to a campaign
[**createCampaign**](SWGCampaignsApi.md#createcampaign) | **POST** /campaigns | Create a campaign
[**createCampaignTemplate**](SWGCampaignsApi.md#createcampaigntemplate) | **POST** /campaigns/templates | Create a campaign template
[**deleteCampaign**](SWGCampaignsApi.md#deletecampaign) | **DELETE** /campaigns/{id} | Delete a campaign
[**deleteCampaignTemplate**](SWGCampaignsApi.md#deletecampaigntemplate) | **DELETE** /campaigns/templates/{id} | Delete a campaign template
[**getCampaign**](SWGCampaignsApi.md#getcampaign) | **GET** /campaigns/{id} | Returns a single campaign
[**getCampaignChallenges**](SWGCampaignsApi.md#getcampaignchallenges) | **GET** /campaigns/{id}/challenges | List the challenges associated with a campaign
[**getCampaignTemplate**](SWGCampaignsApi.md#getcampaigntemplate) | **GET** /campaigns/templates/{id} | Get a single campaign template
[**getCampaignTemplates**](SWGCampaignsApi.md#getcampaigntemplates) | **GET** /campaigns/templates | List and search campaign templates
[**getCampaigns**](SWGCampaignsApi.md#getcampaigns) | **GET** /campaigns | List and search campaigns
[**removeChallengeFromCampaign**](SWGCampaignsApi.md#removechallengefromcampaign) | **DELETE** /campaigns/{campaign_id}/challenges/{id} | Remove a challenge from a campaign
[**updateCampaign**](SWGCampaignsApi.md#updatecampaign) | **PUT** /campaigns/{id} | Update a campaign
[**updateCampaignTemplate**](SWGCampaignsApi.md#updatecampaigntemplate) | **PUT** /campaigns/templates/{id} | Update an campaign template
...
[apiInstance addChallengeToCampaignWithId:_id
          ...
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling SWGCampaignsApi->addChallengeToCampaign: %@", error);
                        }
                    }];
```
...
[apiInstance createCampaignWithCampaignResource:campaignResource
          completionHandler: ^(SWGCampaignResource* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling SWGCampaignsApi->createCampaign: %@", error);
                        }
                    }];
```
...
[apiInstance createCampaignTemplateWithCampaignTemplateResource:campaignTemplateResource
          completionHandler: ^(SWGTemplateResource* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling SWGCampaignsApi->createCampaignTemplate: %@", error);
                        }
                    }];
```
...
[apiInstance deleteCampaignWithId:_id
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling SWGCampaignsApi->deleteCampaign: %@", error);
                        }
                    }];
```
...
[apiInstance deleteCampaignTemplateWithId:_id
          ...
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling SWGCampaignsApi->deleteCampaignTemplate: %@", error);
                        }
                    }];
```
...
[apiInstance getCampaignWithId:_id
          completionHandler: ^(SWGCampaignResource* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling SWGCampaignsApi->getCampaign: %@", error);
                        }
                    }];
```
...
[apiInstance getCampaignChallengesWithId:_id
          completionHandler: ^(SWGPageResourceChallengeResource_* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling SWGCampaignsApi->getCampaignChallenges: %@", error);
                        }
                    }];
```
...
[apiInstance getCampaignTemplateWithId:_id
          completionHandler: ^(SWGTemplateResource* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling SWGCampaignsApi->getCampaignTemplate: %@", error);
                        }
                    }];
```
...
[apiInstance getCampaignTemplatesWithSize:size
          ...
          completionHandler: ^(SWGPageResourceTemplateResource_* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling SWGCampaignsApi->getCampaignTemplates: %@", error);
                        }
                    }];
```
...
[apiInstance getCampaignsWithFilterActive:filterActive
              ...
              page:page
              order:order
          completionHandler: ^(SWGPageResourceCampaignResource_* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling SWGCampaignsApi->getCampaigns: %@", error);
                        }
                    }];
```
...
[**SWGPageResourceCampaignResource_***](SWGPageResourceCampaignResource_.md)
...
[apiInstance removeChallengeFromCampaignWithCampaignId:campaignId
          ...
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling SWGCampaignsApi->removeChallengeFromCampaign: %@", error);
                        }
                    }];
```
...
[apiInstance updateCampaignWithId:_id
          ...
          completionHandler: ^(SWGCampaignResource* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling SWGCampaignsApi->updateCampaign: %@", error);
                        }
                    }];
```
...
[apiInstance updateCampaignTemplateWithId:_id
          ...
          completionHandler: ^(SWGTemplateResource* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling SWGCampaignsApi->updateCampaignTemplate: %@", error);
                        }
                    }];
```
