...
**items** | [**NSArray&lt;SWGInvoiceItemResource&gt;***](SWGInvoiceItemResource.md) | A list of items within the invoice | [optional] 
...
**user** | [**SWGSimpleUserResource***](SWGSimpleUserResource.md) | The owner of the invoice | [optional] 
