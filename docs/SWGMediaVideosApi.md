...
[**deleteRelationshipUsingDELETE**](SWGMediaVideosApi.md#deleterelationshipusingdelete) | **DELETE** /media/videos/{video_id}/related/{id} | Delete a video&#39;s relationship
...
[**updateRelationshipUsingPUT**](SWGMediaVideosApi.md#updaterelationshipusingput) | **PUT** /media/videos/{video_id}/related/{id}/relationship_details | Update a video&#39;s relationship details
...
// Delete a video's relationship
[apiInstance deleteRelationshipUsingDELETEWithVideoId:videoId
              _id:_id
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling SWGMediaVideosApi->deleteRelationshipUsingDELETE: %@", error);
                        }
                    }];
```
...
// Update a video's relationship details
[apiInstance updateRelationshipUsingPUTWithVideoId:videoId
              relationshipId:relationshipId
              details:details
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling SWGMediaVideosApi->updateRelationshipUsingPUT: %@", error);
                        }
                    }];
```
