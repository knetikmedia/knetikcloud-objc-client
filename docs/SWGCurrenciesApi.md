...
------------- | ------------- | -------------
[**createCurrency**](SWGCurrenciesApi.md#createcurrency) | **POST** /currencies | Create a currency
[**deleteCurrency**](SWGCurrenciesApi.md#deletecurrency) | **DELETE** /currencies/{code} | Delete a currency
[**getCurrencies**](SWGCurrenciesApi.md#getcurrencies) | **GET** /currencies | List and search currencies
[**getCurrency**](SWGCurrenciesApi.md#getcurrency) | **GET** /currencies/{code} | Get a single currency
[**updateCurrency**](SWGCurrenciesApi.md#updatecurrency) | **PUT** /currencies/{code} | Update a currency
...
[apiInstance createCurrencyWithCurrency:currency
          completionHandler: ^(SWGCurrencyResource* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling SWGCurrenciesApi->createCurrency: %@", error);
                        }
                    }];
```
...
[apiInstance deleteCurrencyWithCode:code
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling SWGCurrenciesApi->deleteCurrency: %@", error);
                        }
                    }];
```
...
[apiInstance getCurrenciesWithFilterEnabledCurrencies:filterEnabledCurrencies
          ...
          completionHandler: ^(SWGPageResourceCurrencyResource_* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling SWGCurrenciesApi->getCurrencies: %@", error);
                        }
                    }];
```
...
[apiInstance getCurrencyWithCode:code
          completionHandler: ^(SWGCurrencyResource* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling SWGCurrenciesApi->getCurrency: %@", error);
                        }
                    }];
```
...
[apiInstance updateCurrencyWithCode:code
          ...
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling SWGCurrenciesApi->updateCurrency: %@", error);
                        }
                    }];
```
