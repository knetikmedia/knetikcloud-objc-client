...
[apiInstance getLevelsUsingGETWithFilterName:filterName
              ...
              page:page
              order:order
          completionHandler: ^(SWGPageLevelingResource_* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
...
[**SWGPageLevelingResource_***](SWGPageLevelingResource_.md)
...
[apiInstance getUserLevelsUsingGETWithUserId:userId
          completionHandler: ^(SWGPageUserLevelingResource_* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
...
[**SWGPageUserLevelingResource_***](SWGPageUserLevelingResource_.md)
