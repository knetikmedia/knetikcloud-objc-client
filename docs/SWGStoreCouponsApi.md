...
```objc
-(NSURLSessionTask*) createCouponItemUsingPOSTWithCouponItem: (SWGCouponItem*) couponItem
...
```objc
-(NSURLSessionTask*) createCouponTemplateUsingPOSTWithCouponTemplateResource: (SWGItemTemplateResource*) couponTemplateResource
...
```objc
-(NSURLSessionTask*) deleteCouponItemUsingDELETEWithId: (NSNumber*) _id
...
```objc
-(NSURLSessionTask*) deleteCouponTemplateUsingDELETEWithId: (NSString*) _id
...
```objc
-(NSURLSessionTask*) getCouponItemUsingGETWithId: (NSNumber*) _id
        completionHandler: (void (^)(SWGCouponItem* output, NSError* error)) handler;
```
...
```objc
-(NSURLSessionTask*) getCouponTemplateUsingGETWithId: (NSString*) _id
        completionHandler: (void (^)(SWGItemTemplateResource* output, NSError* error)) handler;
```
...
```objc
-(NSURLSessionTask*) getCouponTemplatesUsingGETWithSize: (NSNumber*) size
    page: (NSNumber*) page
...
```objc
-(NSURLSessionTask*) updateCouponItemUsingPUTWithId: (NSNumber*) _id
...
```objc
-(NSURLSessionTask*) updateCouponTemplateUsingPUTWithId: (NSString*) _id
