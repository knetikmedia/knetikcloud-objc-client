...
[**grantEntitlementUsingPOST**](SWGUsersInventoryApi.md#grantentitlementusingpost) | **POST** /users/{user_id}/entitlements/ | Grant an entitlement
...
// Grant an entitlement
[apiInstance grantEntitlementUsingPOSTWithUserId:userId
              grantRequest:grantRequest
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling SWGUsersInventoryApi->grantEntitlementUsingPOST: %@", error);
                        }
                    }];
```
