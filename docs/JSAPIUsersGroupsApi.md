...
-(NSURLSessionTask*) addMemberToGroupWithUniqueName: (NSString*) uniqueName
    username: (JSAPIGroupMemberResource*) username
...
JSAPIGroupMemberResource* username = [[JSAPIGroupMemberResource alloc] init]; // The username of a user to add to the group
 ...
 **username** | [**JSAPIGroupMemberResource***](JSAPIGroupMemberResource*.md)| The username of a user to add to the group | 
