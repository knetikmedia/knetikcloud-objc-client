...
[**searchQuestionTags**](SWGGamificationTriviaApi.md#searchquestiontags) | **GET** /trivia/tags | List and search tags by the beginning of the string
...
[apiInstance searchQuestionTagsWithFilterSearch:filterSearch
          ...
          completionHandler: ^(SWGCollectionString_* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling SWGGamificationTriviaApi->searchQuestionTags: %@", error);
                        }
                    }];
```
