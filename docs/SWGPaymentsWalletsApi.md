...
```objc
-(NSURLSessionTask*) getWalletTotalsUsingGETWithCompletionHandler: 
...
# **getWalletUsingGET**
```objc
-(NSURLSessionTask*) getWalletUsingGETWithUserId: (NSNumber*) userId
...
# **getWalletsUsingGET**
```objc
-(NSURLSessionTask*) getWalletsUsingGETWithUserId: (NSNumber*) userId
...
# **getWalletsUsingGET1**
```objc
-(NSURLSessionTask*) getWalletsUsingGET1WithSize: (NSNumber*) size
    page: (NSNumber*) page
...
```objc
-(NSURLSessionTask*) transactionHistoryUsingGETWithFilterInvoice: (NSNumber*) filterInvoice
...
```objc
-(NSURLSessionTask*) updateBalanceUsingPUTWithUserId: (NSNumber*) userId
    currencyCode: (NSString*) currencyCode
...
```objc
-(NSURLSessionTask*) userTransactionHistoryUsingGETWithUserId: (NSNumber*) userId
    currencyCode: (NSString*) currencyCode
    filterType: (NSString*) filterType
    filterMaxDate: (NSNumber*) filterMaxDate
    filterMinDate: (NSNumber*) filterMinDate
