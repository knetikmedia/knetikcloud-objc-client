...
```objc
-(NSNumber*) createItemTemplateUsingPOSTWithItemTemplateResource: (SWGItemTemplateResource*) itemTemplateResource
...
SWGItemTemplateResource* itemTemplateResource = [[SWGItemTemplateResource alloc] init]; // The new item template (optional)
...
------------- | ------------- | ------------- | -------------
 **itemTemplateResource** | [**SWGItemTemplateResource***](SWGItemTemplateResource*.md)| The new item template | [optional] 
...
[apiInstance getItemTemplatesUsingGETWithSize:size
              page:page
              order:order
          completionHandler: ^(SWGPageItemTemplateResource_* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
...
[**SWGPageItemTemplateResource_***](SWGPageItemTemplateResource_.md)
...
[apiInstance getStoreItemsUsingGETWithFilterNameSearch:filterNameSearch
              ...
              page:page
              order:order
          completionHandler: ^(SWGPageStoreItem_* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
...
[**SWGPageStoreItem_***](SWGPageStoreItem_.md)
...
-(NSNumber*) updateItemTemplateUsingPUTWithId: (NSString*) _id
    itemTemplateResource: (SWGItemTemplateResource*) itemTemplateResource
        completionHandler: (void (^)(NSError* error)) handler;
```
...
NSString* _id = @"_id_example"; // The id of the template
SWGItemTemplateResource* itemTemplateResource = [[SWGItemTemplateResource alloc] init]; // The item template resource object (optional)
...
------------- | ------------- | ------------- | -------------
 **_id** | **NSString***| The id of the template | 
 **itemTemplateResource** | [**SWGItemTemplateResource***](SWGItemTemplateResource*.md)| The item template resource object | [optional] 
