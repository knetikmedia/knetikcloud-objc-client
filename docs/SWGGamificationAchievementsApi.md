...
[apiInstance getAllUserProgressForAchievementUsingGETWithAchievementName:achievementName
              ...
              size:size
              page:page
          completionHandler: ^(SWGPageUserAchievementGroupResource_* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
...
[**SWGPageUserAchievementGroupResource_***](SWGPageUserAchievementGroupResource_.md)
