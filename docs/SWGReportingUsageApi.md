...
[**getUsageEndpoints**](SWGReportingUsageApi.md#getusageendpoints) | **GET** /reporting/usage/endpoints | Returns list of endpoints called (method and url)
...
[apiInstance getUsageEndpointsWithStartDate:startDate
          ...
          completionHandler: ^(NSArray<NSString*>* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling SWGReportingUsageApi->getUsageEndpoints: %@", error);
                        }
                    }];
```
