...
------------- | ------------- | -------------
[**getUserSubscriptionDetails**](SWGUsersSubscriptionsApi.md#getusersubscriptiondetails) | **GET** /users/{user_id}/subscriptions/{inventory_id} | Get details about a user&#39;s subscription
[**getUsersSubscriptionDetails**](SWGUsersSubscriptionsApi.md#getuserssubscriptiondetails) | **GET** /users/{user_id}/subscriptions | Get details about a user&#39;s subscriptions
[**reactivateUserSubscription**](SWGUsersSubscriptionsApi.md#reactivateusersubscription) | **POST** /users/{user_id}/subscriptions/{inventory_id}/reactivate | Reactivate a subscription and charge fee
[**setSubscriptionBillDate**](SWGUsersSubscriptionsApi.md#setsubscriptionbilldate) | **PUT** /users/{user_id}/subscriptions/{inventory_id}/bill-date | Set a new date to bill a subscription on
[**setSubscriptionPaymentMethod**](SWGUsersSubscriptionsApi.md#setsubscriptionpaymentmethod) | **PUT** /users/{user_id}/subscriptions/{inventory_id}/payment-method | Set the payment method to use for a subscription
[**setSubscriptionStatus**](SWGUsersSubscriptionsApi.md#setsubscriptionstatus) | **PUT** /users/{user_id}/subscriptions/{inventory_id}/status | Set the status of a subscription
[**setUserSubscriptionPlan**](SWGUsersSubscriptionsApi.md#setusersubscriptionplan) | **PUT** /users/{user_id}/subscriptions/{inventory_id}/plan | Set a new subscription plan for a user
...
[apiInstance getUserSubscriptionDetailsWithUserId:userId
          ...
          completionHandler: ^(SWGInventorySubscriptionResource* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling SWGUsersSubscriptionsApi->getUserSubscriptionDetails: %@", error);
                        }
                    }];
```
...
[apiInstance getUsersSubscriptionDetailsWithUserId:userId
          completionHandler: ^(NSArray<SWGInventorySubscriptionResource>* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling SWGUsersSubscriptionsApi->getUsersSubscriptionDetails: %@", error);
                        }
                    }];
```
...
[apiInstance reactivateUserSubscriptionWithUserId:userId
          ...
          completionHandler: ^(SWGInvoiceResource* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling SWGUsersSubscriptionsApi->reactivateUserSubscription: %@", error);
                        }
                    }];
```
...
[apiInstance setSubscriptionBillDateWithUserId:userId
          ...
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling SWGUsersSubscriptionsApi->setSubscriptionBillDate: %@", error);
                        }
                    }];
```
...
[apiInstance setSubscriptionPaymentMethodWithUserId:userId
          ...
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling SWGUsersSubscriptionsApi->setSubscriptionPaymentMethod: %@", error);
                        }
                    }];
```
...
[apiInstance setSubscriptionStatusWithUserId:userId
          ...
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling SWGUsersSubscriptionsApi->setSubscriptionStatus: %@", error);
                        }
                    }];
```
...
[apiInstance setUserSubscriptionPlanWithUserId:userId
          ...
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling SWGUsersSubscriptionsApi->setUserSubscriptionPlan: %@", error);
                        }
                    }];
```
